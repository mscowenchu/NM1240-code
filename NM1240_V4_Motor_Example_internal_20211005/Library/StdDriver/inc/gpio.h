 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 2020/07/14 09:43 $
 * @brief    NM1240 series GPIO driver header file
 *
 * @note
...
/** @addtogroup NM1240_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup NM1240_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
#define GPIO_MODE_OUTPUT        0x1UL   /*!< Push-pull Output Mode */
#define GPIO_MODE_OPEN_DRAIN    0x2UL   /*!< Open-Drain Mode */
#define GPIO_MODE_QUASI         0x3UL   /*!< Quasi-bidirectional Mode */
/*---------------------------------------------------------------------------------------------------------*/
/*  GPIO Interrupt Type Constant Definitions (Notice: MSB is used as a flag by functions.)                                                              */
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NM1240_GPIO_EXPORTED_CONSTANTS */


/** @addtogroup NM1240_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
 ...
 *
 * @param[in]   port        GPIO port. It could be PA, PB, PC, PD, PE, PF.
 *
 * @return      The specified GPIO port offset
 *
 * @details     Calculate GPIO port offset.
 */
#define GPIO_GET_OFFSET(port)                  ((port & 0x1FF) / ((uint32_t)PB-(uint32_t)PA))
...
/*@}*/ /* end of group NM1240_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1240_GPIO_Driver */
