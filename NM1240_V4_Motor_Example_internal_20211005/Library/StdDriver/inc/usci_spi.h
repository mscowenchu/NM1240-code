 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 2020/07/24 14:25 $
 * @brief    NM1240 USCI_SPI driver header file
 *
 * @note
...
/** @addtogroup NM1240_USCI_SPI_Driver USPI Driver (USCI SPI Mode Driver)
  @{
*/

/** @addtogroup NM1240_USCI_SPI_EXPORTED_CONSTANTS USPI Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1240_USCI_SPI_EXPORTED_CONSTANTS */


/** @addtogroup NM1240_USCI_SPI_EXPORTED_FUNCTIONS USPI Exported Functions
  @{
*/
...
/**
  * @brief        This macro enables USPI DMA Control.
  * @param[in]    uspi     The pointer of the specified USCI_SPI module.
  * @param[in]    u32CtrlMask DMA control, should be (use '|' for multiple selections)
  *                                  - \ref USPI_DMACTL_DMARST_Msk
  *                                  - \ref USPI_DMACTL_TXDMAEN_Msk
  *                                  - \ref USPI_DMACTL_RXDMAEN_Msk
  *                                  - \ref USPI_DMACTL_DMAEN_Msk
  * @return None
  */
#define USPI_ENABLE_DMA_CTL(uspi, u32CtrlMask)    ((uspi)->DMACTL |= (u32CtrlMask))

/**
  * @brief        This macro disables USPI DMA Control.
  * @param[in]    uspi     The pointer of the specified USCI_SPI module.
  * @param[in]    u32CtrlMask DMA control, should be (use '|' for multiple selections)
  *                                  - \ref USPI_DMACTL_DMARST_Msk
  *                                  - \ref USPI_DMACTL_TXDMAEN_Msk
  ...
  * @return None
  */
#define USPI_DISABLE_DMA_CTL(uspi, u32CtrlMask)    ((uspi)->DMACTL &= ~(u32CtrlMask))
...
/*@}*/ /* end of group NM1240_USCI_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1240_USCI_SPI_Driver */
