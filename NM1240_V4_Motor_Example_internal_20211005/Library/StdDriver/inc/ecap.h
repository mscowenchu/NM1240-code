 ...
 * @brief    NM1240 ECAP driver header file
 *
 * @note
...
/** @addtogroup NM1240_ECAP_EXPORTED_CONSTANTS ECAP Exported Constants
  @{
*/
...
#define ECAP_NOISE_FILTER_CLKDIV_128        (6UL)   /*!< Noise filter clock divide by 128 */
#define ECAP_NOISE_FILTER_CLKDIV_256        (7UL)   /*!< Noise filter clock divide by 256 */
...
#define ECAP_CNT_CLR_BY_CAPTF               (BIT1)          /*!< Input channel counter cleared by Capture                 */
#define ECAP_CNT_CLR_BY_CAPTF_CMP           (BIT0 | BIT1)   /*!< Input channel counter cleared by Compare-Match & capture */
...
/*---------------------------------------------------------------------------------------------------------*/
/* ECAP Reload trigger source in ECAP_CTL2 register                                                        */
/*---------------------------------------------------------------------------------------------------------*/
#define ECAP_RELOAD_TRIG_SRC_CAPF0             (BIT0)    /*!< ECAP counter reload trigger source CAPF0 selection */
#define ECAP_RELOAD_TRIG_SRC_CAPF1             (BIT1)    /*!< ECAP counter reload trigger source CAPF1 selection */
#define ECAP_RELOAD_TRIG_SRC_CAPF2             (BIT2)    /*!< ECAP counter reload trigger source CAPF2 selection */
#define ECAP_RELOAD_TRIG_SRC_OVF               (BIT3)    /*!< ECAP counter reload trigger source OVF selection   */

/*---------------------------------------------------------------------------------------------------------*/
/* ECAP Clear CAPCNT trigger source in ECAP_CTL2 register                                                  */
/*---------------------------------------------------------------------------------------------------------*/
#define ECAP_CNT_CLR_BY_CAPTF0               (BIT8)
#define ECAP_CNT_CLR_BY_CAPTF1               (BIT9)
#define ECAP_CNT_CLR_BY_CAPTF2               (BIT10)


/*@}*/ /* end of group NM1240_ECAP_EXPORTED_CONSTANTS */
...
/**
  ...
  *                         - \ref ECAP_NOISE_FILTER_CLKDIV_128
  *                         - \ref ECAP_NOISE_FILTER_CLKDIV_256
  * @return     None
  * \hideinitializer
  */
#define ECAP_SET_NOISE_FILTER_CLKDIV(ecap, u32Clkdiv)       ( (ecap)->CTL0 = ((ecap)->CTL0 & (~ECAP_CTL0_NFCLKS_Msk)) | (((u32Clkdiv) & 0x7) << ECAP_CTL0_NFCLKS_Pos) )
...
/**
  ...
  * \hideinitializer
  */
#define ECAP_NOISE_FILTER_ENABLE(ecap, u32Clkdiv)   ( (ecap)->CTL0 = ((ecap)->CTL0 & (~(ECAP_CTL0_NFCLKS_Msk | ECAP_CTL0_CAPNFDIS_Msk))) | (((u32Clkdiv) & 0x7) << ECAP_CTL0_NFCLKS_Pos) )

/**
  * @brief      This macro is used to enable input channel unit
  * @param[in]  ecap        The pointer of the specified ECAP module
  * @param[in]  u32Mask     The input channel mask (use '|' for multiple selections)
...
#define ECAP_SEL_INPUT_SRC(ecap, u32Index, u32Src)  ( (ecap)->CTL0 = ( (ecap)->CTL0 & ~(ECAP_CTL0_CAP0SEL_Msk << ((u32Index)<<1)) ) | \
                                                                  ( ((u32Src) & 0x1) << ECAP_CTL0_CAP0SEL_Pos << ((u32Index)<<1)) )
...
/**
  ...
  *                         - \ref ECAP_CNT_CLR_BY_CAPTF (trigger by CAPTF0, CAPTF1, or CAPTF2)
  *                         - \ref ECAP_CNT_CLR_BY_CAPTF_CMP
  * @return     None
...
#define ECAP_SET_CNT_CLEAR_EVENT(ecap, u32Event) \
            (ecap)->CTL0 = ((ecap)->CTL0 & ~(ECAP_CTL0_CMPCLR_Msk | ECAP_CTL0_CPTCLR_Msk)) | ((u32Event) << ECAP_CTL0_CMPCLR_Pos); \
						(ecap)->CTL2 &= ~ECAP_CTL2_CPTCLRMS_Msk;

/**
  * @brief      This macro is used to select ECAP CAPTF trigger source to clear capture counter
  * @param[in]  ecap        The pointer of the specified ECAP module
  * @param[in]  u32TrigSrc  The input source (use '|' for multiple selections)
  *                         - \ref ECAP_CNT_CLR_BY_CAPTF0
  *                         - \ref ECAP_CNT_CLR_BY_CAPTF1
  *                         - \ref ECAP_CNT_CLR_BY_CAPTF2
  * @details    This macro will select multiple CAPTF trigger sources to clear capture. 
  *             It's active after ECAP_SET_CNT_CLEAR_EVENT(ECAP_CNT_CLR_BY_CAPTF) or ECAP_SET_CNT_CLEAR_EVENT(ECAP_CNT_CLR_BY_CAPTF_CMP).
  * @return     None
  * \hideinitializer
  */
#define ECAP_SEL_CNT_CLEAR_CAPTF_EVENT(ecap, u32TrigSrc)     ( (ecap)->CTL2 |= (ECAP_CTL2_CPTCLRMS_Msk | (u32TrigSrc)) )
...
/**
  ...
  * @details    This macro will select multiple capture counter reload trigger sources.
  * @return     None
  * \hideinitializer
  */
#define ECAP_SEL_RELOAD_TRIG_SRC(ecap, u32TrigSrc)     ( (ecap)->CTL2 |= (ECAP_CTL2_RLDMS_Msk | (u32TrigSrc)) )
