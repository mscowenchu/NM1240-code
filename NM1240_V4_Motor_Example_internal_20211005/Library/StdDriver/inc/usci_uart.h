 ...
 * @brief    NM1240 USCI UART (UUART) driver header file
 *
 * @note
...
/** @addtogroup NM1240_USCI_UART_Driver UUART Driver (USCI UART Mode Driver)
  @{
*/

/** @addtogroup NM1240_USCI_UART_EXPORTED_CONSTANTS UUART Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1240_USCI_UART_EXPORTED_CONSTANTS */


/** @addtogroup NM1240_USCI_UART_EXPORTED_FUNCTIONS UUART Exported Functions
  @{
*/
...
/**
  * @brief        This macro enables UUART DMA Control.
  * @param[in]    uuart     The pointer of the specified USCI_UART module.
  * @param[in]    u32CtrlMask DMA control, should be (use '|' for multiple selections)
  *                                  - \ref UUART_DMACTL_DMARST_Msk
  *                                  - \ref UUART_DMACTL_TXDMAEN_Msk
  *                                  - \ref UUART_DMACTL_RXDMAEN_Msk
  *                                  - \ref UUART_DMACTL_DMAEN_Msk
  * @return None
  */
#define UUART_ENABLE_DMA_CTL(uuart, u32CtrlMask)    ((uuart)->DMACTL |= (u32CtrlMask))

/**
  * @brief        This macro disables UUART DMA Control.
  * @param[in]    uuart     The pointer of the specified USCI_UART module.
  * @param[in]    u32CtrlMask DMA control, should be (use '|' for multiple selections)
  *                                  - \ref UUART_DMACTL_DMARST_Msk
  *                                  - \ref UUART_DMACTL_TXDMAEN_Msk
  ...
  * @return None
  */
#define UUART_DISABLE_DMA_CTL(uuart, u32CtrlMask)    ((uuart)->DMACTL &= ~(u32CtrlMask))
...
/*@}*/ /* end of group NM1240_USCI_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1240_USCI_UART_Driver */
