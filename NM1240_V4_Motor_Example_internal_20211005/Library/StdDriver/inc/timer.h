 ...
 * @brief    NM1240 TIMER driver header file
 *
 * @note
...
/** @addtogroup NM1240_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup NM1240_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
#define TIMER_CCAP_CNT_TIMER2                  ((3UL << TIMER_CCAPCTL_CNTSEL_Pos) | (0UL << TIMER_CCAPCTL_CNTSEL2_Pos))  /*!<  Timer2 as counter of continuous capture */
...
/*@}*/ /* end of group NM1240_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup NM1240_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
#define TIMER_CCAP_Counter_Select(ccap, cnt_sel) ((ccap)->CCAPCTL = \
                                 ((ccap)->CCAPCTL & ~(TIMER_CCAPCTL_CNTSEL_Msk|TIMER_CCAPCTL_CNTSEL2_Msk)) | cnt_sel)
...
/*@}*/ /* end of group NM1240_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1240_TIMER_Driver */
