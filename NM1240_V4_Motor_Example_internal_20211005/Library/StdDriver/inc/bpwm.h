 ...
 * @brief    NM1240 BPWM driver header file
 *
 * @note
...
/** @addtogroup NM1240_BPWM_Driver BPWM Driver
  @{
*/

/** @addtogroup NM1240_BPWM_EXPORTED_CONSTANTS BPWM Exported Constants
  @{
*/
...
/*@}*/ /* end of group NM1240_BPWM_EXPORTED_CONSTANTS */


/** @addtogroup NM1240_BPWM_EXPORTED_FUNCTIONS BPWM Exported Functions
  @{
*/
 ...
 * \hideinitializer
 */
#define BPWM_SET_CMR(bpwm, u32ChannelNum, u32CMR) (*((__IO uint32_t *) ((((uint32_t)&((bpwm)->CMPDAT0)) + (u32ChannelNum) * 12))) = (u32CMR & BPWM_CMPDAT0_CMP_Msk))
 ...
 * \hideinitializer
 */
#define BPWM_SET_CNR(bpwm, u32ChannelNum, u32CNR)  (*((__IO uint32_t *) ((((uint32_t)&((bpwm)->PERIOD0)) + (u32ChannelNum) * 12))) = (u32CNR & BPWM_PERIOD0_PERIOD_Msk))
 ...
 *                  - \ref BPWM_CH_1_MASK
 * @return None
 * @details This macro is used to enable synchronous mode of BPWM module.
 * \hideinitializer
 */
#define BPWM_ENABLE_SYNC_MODE(bpwm, u32ChannelMask) (bpwm->CTL |= (u32ChannelMask << BPWM_CTL_BP0SYNEPWM_Pos))
...
/*@}*/ /* end of group NM1240_BPWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NM1240_BPWM_Driver */
