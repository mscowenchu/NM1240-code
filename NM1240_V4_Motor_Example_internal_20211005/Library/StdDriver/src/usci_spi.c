 ...
 * @brief    NM1240 USCI_SPI driver source file
 *
 * @note
...
/**
  ...
  *                    - \ref USPI_MODE_2
  *                    - \ref USPI_MODE_3
  * @param[in]  u32DataWidth The data word length (amount of bits) of a USCI_SPI transaction. Valid calues are from 4 to 16.
