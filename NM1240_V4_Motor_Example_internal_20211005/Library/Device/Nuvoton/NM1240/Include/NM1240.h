...
/**
  * \page pg1 NuMicro NM1240 BSP Directory Structure
  * Please refer to "Readme.pdf" under BSP root directory for the BSP directory structure
  *
  * \page pg2 Revision History
  * Please refer to "NuMicro NM1240 CMSIS BSP Revision History.pdf" under BSP\\Document directory for the BSP Revision History
  *
*/
...
typedef enum IRQn
{
    ...
    GP_IRQn                     = 4,        /*!< GPIO_PA/PB/PC/PD/PE/PF Interrupt                     */
...
#include "system_NM1240.h"              /* NM1240 System                                          */
 ...
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[11]    |HFAULTRF|Hard fault reset Flag
 * |        |          |0 = No reset from Hardfault.
 * |        |          |1 = The Cortex-M0 Core and FMC are reset by software setting HARDFAULTRST to 1.
 * |        |          |Note: Write 1 to clear this bit to 0.
 * @var SYS_T::IPRST0
 ...
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[2]     |DMARST    |DMA One-shot Reset (Write Protect)
 * |        |          |Setting this bit will only reset the DMA, and this bit will automatically return to 0 after the 2 clock cycles.
 * |        |          |0 = DMA normal operation.
 * |        |          |1 = DMA one-shot reset.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * @var SYS_T::IPRST1
 ...
 * |[12]    |OPRST     |OP Controller Reset
 * |        |          |0 = OP controller normal operation.
 * |        |          |1 = OP controller reset.
 ...
 * |[26]    |USCI2RST  |USCI2 Controller Reset
 ...
 * |        |          |0 = LVR operate in normal mode (default).
 * |        |          |1 = LVR Low Power mode Enabled.
 ...
 * |        |          |Note: After this bit is set to 1, the value of temperature sensor output can be obtained from A/D conversion result
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |POROFF    |Power-on Reset Enable Control (Write Protect)
 ...
 * @var SYS_T::GPE_MFP
 * Offset: 0x40  GPIOE Multiple Function Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var SYS_T::GPF_MFP
 * Offset: 0x44  GPIOF Multiple Function Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |REGLCTL   |Register Lock Control Disable Index (Read Only)
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |VTEMP25   |The ADC value of thermal diode in 25oC  (+/- 2) = (VTEMP125 + 512) LSB at VDD = 5000mV.
 * |[15:8]  |VTEMP125  |The ADC value of thermal diode in 125oC  (+/- 3) = (VTEMP125 + 256) LSB at VDD = 5000mV.
 * |[23:16] |BGVAL     |The ADC value of Band-Gap = (BGVAL+ 896) LSB at VDD = 5000mV. Software  can use this value to derivation the VDD voltage.
 */
    ...
    __IO uint32_t GPE_MFP;               /*!< [0x0040] GPIOE Multiple Function Control Register                         */
    __IO uint32_t GPF_MFP;               /*!< [0x0044] GPIOF Multiple Function Control Register                         */
    __I  uint32_t RESERVE3[46];
...
#define SYS_RSTSTS_HFAULTRF_Pos          (11)                                              /*!< SYS_T::RSTSTS: HFAULTRF Position       */
#define SYS_RSTSTS_HFAULTRF_Msk          (0x1ul << SYS_RSTSTS_HFAULTRF_Pos)                /*!< SYS_T::RSTSTS: HFAULTRF Mask           */
...
#define SYS_IPRST0_GDMARST_Pos           (2)                                               /*!< SYS_T::IPRST0: GDMARST Position        */
#define SYS_IPRST0_GDMARST_Msk           (0x1ul << SYS_IPRST0_GDMARST_Pos)                 /*!< SYS_T::IPRST0: GDMARST Mask            */
...
#define SYS_IPRST1_OPRST_Pos             (12)                                              /*!< SYS_T::IPRST1: OPRST Position          */
#define SYS_IPRST1_OPRST_Msk             (0x1ul << SYS_IPRST1_OPRST_Pos)                   /*!< SYS_T::IPRST1: OPRST Mask              */
...
#define SYS_IPRST1_USCI2RST_Pos          (26)                                              /*!< SYS_T::IPRST1: USCI2RST Position       */
#define SYS_IPRST1_USCI2RST_Msk          (0x1ul << SYS_IPRST1_USCI2RST_Pos)                /*!< SYS_T::IPRST1: USCI2RST Mask           */
...
#define SYS_BODCTL_LVRLPM_Pos            (6)                                               /*!< SYS_T::BODCTL: LVRLPM Position         */
#define SYS_BODCTL_LVRLPM_Msk            (0x1ul << SYS_BODCTL_LVRLPM_Pos)                  /*!< SYS_T::BODCTL: LVRLPM Mask             */
...
#define SYS_GPA_MFP_PA6MFP_Pos           (24)                                              /*!< SYS_T::GPA_MFP: PA6MFP Position        */
#define SYS_GPA_MFP_PA6MFP_Msk           (0xful << SYS_GPA_MFP_PA6MFP_Pos)                 /*!< SYS_T::GPA_MFP: PA6MFP Mask            */

#define SYS_GPA_MFP_PA7MFP_Pos           (28)                                              /*!< SYS_T::GPA_MFP: PA7MFP Position        */
#define SYS_GPA_MFP_PA7MFP_Msk           (0xful << SYS_GPA_MFP_PA7MFP_Pos)                 /*!< SYS_T::GPA_MFP: PA7MFP Mask            */
...
#define SYS_GPB_MFP_PB5MFP_Pos           (20)                                              /*!< SYS_T::GPB_MFP: PB5MFP Position        */
#define SYS_GPB_MFP_PB5MFP_Msk           (0xful << SYS_GPB_MFP_PB5MFP_Pos)                 /*!< SYS_T::GPB_MFP: PB5MFP Mask            */

#define SYS_GPB_MFP_PB6MFP_Pos           (24)                                              /*!< SYS_T::GPB_MFP: PB6MFP Position        */
#define SYS_GPB_MFP_PB6MFP_Msk           (0xful << SYS_GPB_MFP_PB6MFP_Pos)                 /*!< SYS_T::GPB_MFP: PB6MFP Mask            */

#define SYS_GPB_MFP_PB7MFP_Pos           (28)                                              /*!< SYS_T::GPB_MFP: PB7MFP Position        */
#define SYS_GPB_MFP_PB7MFP_Msk           (0xful << SYS_GPB_MFP_PB7MFP_Pos)                 /*!< SYS_T::GPB_MFP: PB7MFP Mask            */
...
#define SYS_GPC_MFP_PC5MFP_Pos           (20)                                              /*!< SYS_T::GPC_MFP: PC5MFP Position        */
#define SYS_GPC_MFP_PC5MFP_Msk           (0xful << SYS_GPC_MFP_PC5MFP_Pos)                 /*!< SYS_T::GPC_MFP: PC5MFP Mask            */

#define SYS_GPC_MFP_PC6MFP_Pos           (24)                                              /*!< SYS_T::GPC_MFP: PC6MFP Position        */
#define SYS_GPC_MFP_PC6MFP_Msk           (0xful << SYS_GPC_MFP_PC6MFP_Pos)                 /*!< SYS_T::GPC_MFP: PC6MFP Mask            */

#define SYS_GPC_MFP_PC7MFP_Pos           (28)                                              /*!< SYS_T::GPC_MFP: PC7MFP Position        */
#define SYS_GPC_MFP_PC7MFP_Msk           (0xful << SYS_GPC_MFP_PC7MFP_Pos)                 /*!< SYS_T::GPC_MFP: PC7MFP Mask            */

#define SYS_GPD_MFP_PD0MFP_Pos           (0)                                               /*!< SYS_T::GPD_MFP: PD0MFP Position        */
#define SYS_GPD_MFP_PD0MFP_Msk           (0xful << SYS_GPD_MFP_PD0MFP_Pos)                 /*!< SYS_T::GPD_MFP: PD0MFP Mask            */
...
#define SYS_GPD_MFP_PD7MFP_Pos           (28)                                              /*!< SYS_T::GPD_MFP: PD7MFP Position        */
#define SYS_GPD_MFP_PD7MFP_Msk           (0xful << SYS_GPD_MFP_PD7MFP_Pos)                 /*!< SYS_T::GPD_MFP: PD7MFP Mask            */

#define SYS_GPE_MFP_PE0MFP_Pos           (0)                                               /*!< SYS_T::GPE_MFP: PE0MFP Position        */
#define SYS_GPE_MFP_PE0MFP_Msk           (0xful << SYS_GPE_MFP_PE0MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE0MFP Mask            */

#define SYS_GPE_MFP_PE1MFP_Pos           (4)                                               /*!< SYS_T::GPE_MFP: PE1MFP Position        */
#define SYS_GPE_MFP_PE1MFP_Msk           (0xful << SYS_GPE_MFP_PE1MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE1MFP Mask            */

#define SYS_GPE_MFP_PE2MFP_Pos           (8)                                               /*!< SYS_T::GPE_MFP: PE2MFP Position        */
#define SYS_GPE_MFP_PE2MFP_Msk           (0xful << SYS_GPE_MFP_PE2MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE2MFP Mask            */

#define SYS_GPE_MFP_PE3MFP_Pos           (12)                                              /*!< SYS_T::GPE_MFP: PE3MFP Position        */
#define SYS_GPE_MFP_PE3MFP_Msk           (0xful << SYS_GPE_MFP_PE3MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE3MFP Mask            */

#define SYS_GPE_MFP_PE4MFP_Pos           (16)                                              /*!< SYS_T::GPE_MFP: PE4MFP Position        */
#define SYS_GPE_MFP_PE4MFP_Msk           (0xful << SYS_GPE_MFP_PE4MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE4MFP Mask            */

#define SYS_GPE_MFP_PE5MFP_Pos           (20)                                              /*!< SYS_T::GPE_MFP: PE5MFP Position        */
#define SYS_GPE_MFP_PE5MFP_Msk           (0xful << SYS_GPE_MFP_PE5MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE5MFP Mask            */

#define SYS_GPE_MFP_PE6MFP_Pos           (24)                                              /*!< SYS_T::GPE_MFP: PE6MFP Position        */
#define SYS_GPE_MFP_PE6MFP_Msk           (0xful << SYS_GPE_MFP_PE6MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE6MFP Mask            */

#define SYS_GPE_MFP_PE7MFP_Pos           (28)                                              /*!< SYS_T::GPE_MFP: PE7MFP Position        */
#define SYS_GPE_MFP_PE7MFP_Msk           (0xful << SYS_GPE_MFP_PE7MFP_Pos)                 /*!< SYS_T::GPE_MFP: PE7MFP Mask            */

#define SYS_GPF_MFP_PF0MFP_Pos           (0)                                               /*!< SYS_T::GPF_MFP: PF0MFP Position        */
#define SYS_GPF_MFP_PF0MFP_Msk           (0xful << SYS_GPF_MFP_PF0MFP_Pos)                 /*!< SYS_T::GPF_MFP: PF0MFP Mask            */

#define SYS_GPF_MFP_PF1MFP_Pos           (4)                                               /*!< SYS_T::GPF_MFP: PF1MFP Position        */
#define SYS_GPF_MFP_PF1MFP_Msk           (0xful << SYS_GPF_MFP_PF1MFP_Pos)                 /*!< SYS_T::GPF_MFP: PF1MFP Mask            */

#define SYS_GPF_MFP_PF2MFP_Pos           (8)                                               /*!< SYS_T::GPF_MFP: PF2MFP Position        */
#define SYS_GPF_MFP_PF2MFP_Msk           (0xful << SYS_GPF_MFP_PF2MFP_Pos)                 /*!< SYS_T::GPF_MFP: PF2MFP Mask            */

#define SYS_GPF_MFP_PF3MFP_Pos           (12)                                              /*!< SYS_T::GPF_MFP: PF3MFP Position        */
#define SYS_GPF_MFP_PF3MFP_Msk           (0xful << SYS_GPF_MFP_PF3MFP_Pos)                 /*!< SYS_T::GPF_MFP: PF3MFP Mask            */

#define SYS_GPF_MFP_PF4MFP_Pos           (16)                                              /*!< SYS_T::GPF_MFP: PF4MFP Position        */
#define SYS_GPF_MFP_PF4MFP_Msk           (0xful << SYS_GPF_MFP_PF4MFP_Pos)                 /*!< SYS_T::GPF_MFP: PF4MFP Mask            */
...
#define SYS_REGLCTL_REGPROTDIS_Pos       (1)                                               /*!< SYS_T::REGLCTL: REGPROTDIS Position    */
#define SYS_REGLCTL_REGPROTDIS_Msk       (0x7ful << SYS_REGLCTL_REGPROTDIS_Pos)            /*!< SYS_T::REGLCTL: REGPROTDIS Mask        */

#define SYS_TSOFFSET_VTEMP25_Pos         (0)                                               /*!< SYS_T::TSOFFSET: VTEMP25 Position      */
#define SYS_TSOFFSET_VTEMP25_Msk         (0xfful << SYS_TSOFFSET_VTEMP25_Pos)              /*!< SYS_T::TSOFFSET: VTEMP25 Mask          */

#define SYS_TSOFFSET_VTEMP125_Pos        (8)                                               /*!< SYS_T::TSOFFSET: VTEMP125 Position     */
#define SYS_TSOFFSET_VTEMP125_Msk        (0xfful << SYS_TSOFFSET_VTEMP125_Pos)             /*!< SYS_T::TSOFFSET: VTEMP125 Mask         */

#define SYS_TSOFFSET_BGVAL_Pos           (16)                                              /*!< SYS_T::TSOFFSET: BGVAL Position        */
#define SYS_TSOFFSET_BGVAL_Msk           (0xfful << SYS_TSOFFSET_BGVAL_Pos)            	   /*!< SYS_T::TSOFFSET: BGVAL Mask            */
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[1:0]   |EXTCLKEN  |External Clock Enable Control (Write Protect)
 * |        |          |These two bits are default set to “00” and the XT_IN and XT_OUT pins are GPIO.
 * |        |          |00 = Disable external REF_CLK.
 * |        |          |01 = Disable external REF_CLK.
 * |        |          |10 = Disable external REF_CLK.
 * |        |          |11 = Enable external REF_CLK.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 ...
 * |        |          |The delayed clock cycle is 4096 clock cycles when chip works at 4~24 MHz external high speed crystal oscillator (EXT_CLK), and 256 clock cycles when chip works at 48 MHz internal high speed RC oscillator (HIRC).
 ...
 * |        |          |The flag is set if the GPIO, USCI012, WDT, ACMP01, BOD, TMR01 wake-up occurred.
 ...
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[15:14] |PDMODE    |00: LDO off when power down mode
 * |        |          |01: LDO on when power down node
 * |[24]    |HIRCSEL   |0: Internal High Speed RC Oscillator Clock Will Output 48MHz
 ...
 * |[4]     |HDIVCKEN  |Hardware Divider Controller Clock Enable Control
 * |        |          |0 = HDIV peripheral clock Disabled.
 * |        |          |1 = HDIV peripheral clock Enabled.
 * |[8]     |GDMACKEN  |Gereral Direct Memory Access Controller Clock Enable Control 
 * |        |          |0 = GDMA clock Disabled.
 * |        |          |1 = GDMA clock Enabled.
 * @var CLK_T::APBCLK
 ...
 * |[6]     |CLKOCKEN  |CLKO Clock Enable Control
 * |        |          |0 = CLKO clock Disabled.
 * |        |          |1 = CLKO clock Enabled.
 * |[8]     |ECAPCKEN  |Input Capture Clock Enable Control
 * |        |          |0 = CAP clock Disabled.
 * |        |          |1 = CAP clock Enabled.
 * |[12]    |OPCKEN    |OP Clock Enable Control
 * |        |          |0 = OP clock Disabled.
 * |        |          |1 = OP clock Enabled.
 * |[20]    |EPWMCKEN  |Enhanced PWM Clock Enable Control
 * |        |          |0 = EPWM channel 0/1 clock Disabled.
 * |        |          |1 = EPWM channel 0/1 clock Enabled.
 * |[23]    |BPWMCKEN  |Basic PWM Channel 0/1 Clock Enable Control
 * |        |          |0 = BBPWM channel 0/1 clock Disabled.
 * |        |          |1 = BPWM channel 0/1 clock Enabled.
 * |[25]    |USCI1CKEN |USCI1 Clock Enable Control
 * |        |          |0 = USCI1 clock Disabled.
 * |        |          |1 = USCI1 clock Enabled.
 * |[26]    |USCI2CKEN |USCI2 Clock Enable Control
 ...
 * |        |          |00 = Clock source from EXT_CLK.
 * |        |          |01 = Clock source from LIRC.
 * |        |          |10 = Reserved.
 * |        |          |11 = Clock source from HIRC.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * |[4:3]   |STCLKSEL  |CortexR-M0 SysTick Clock Source Selection (Write Protect)
 * |        |          |If SYST_CTL[2]=0, SysTick uses the clock source listed below.
 * |        |          |00 = Clock source from EXT_CLK. 
 * |        |          |01 = Clock source from EXT_CLK/2.
 * |        |          |10 = Clock source from HCLK/2.
 * |        |          |11 = Clock source from HIRC/2.
 * |        |          |Other = Reserved.
 * |        |          |Note: if SysTick clock source is not from HCLK (i.e. SYST_CTL[2] = 0), SysTick clock source must less than or equal to HCLK/2.
 * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
 * @var CLK_T::CLKSEL1
 ...
 * |        |          |00 = Clock source from external crystal oscillator (EXT_CLK).
 * |        |          |01 = Reserved.
 ...
 * |        |          |000 = Clock source from external crystal oscillator (EXT_CLK).
 * |        |          |001 = Clock source from 10 kHz internal low speed RC oscillator (LIRC).
 * |        |          |010 = Clock source from HCLK.
 * |        |          |011 = Clock source from external clock T0 pin.
 * |        |          |100 = Clock source from 48(60) MHz internal high speed RC oscillator (HIRC).
 * |        |          |Others = Reserved.
 ...
 * |        |          |11 = Clock source from 48(60) MHz internal high speed RC oscillator (HIRC).
 * @var CLK_T::CLKDIV
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |REXCLKSTB |External Clock Source Stable Flag (Read Only)
 * |        |          |0 = External  clock is not stable or disabled.
 * |        |          |1 = External  clock is stable and enabled. 
 ...
 * |[5]     |DIV1EN    |Clock Output Divide One Enable Control
...
#define CLK_PWRCTL_EXTCLKEN_Pos          (0)                                               /*!< CLK_T::PWRCTL: EXTCLKEN Position       */
#define CLK_PWRCTL_EXTCLKEN_Msk          (0x3ul << CLK_PWRCTL_EXTCLKEN_Pos)                /*!< CLK_T::PWRCTL: EXTCLKEN Mask           */
...
#define CLK_PWRCTL_PD_MODE_Pos           (14)                                              /*!< CLK_T::PWRCTL: PD_MODE Position        */
#define CLK_PWRCTL_PD_MODE_Msk           (0x3ul << CLK_PWRCTL_PD_MODE_Pos)                 /*!< CLK_T::PWRCTL: PD_MODE Mask            */

#define CLK_PWRCTL_HIRC_SEL_Pos          (24)                                              /*!< CLK_T::PWRCTL: HIRC_SEL Position       */
#define CLK_PWRCTL_HIRC_SEL_Msk          (0x1ul << CLK_PWRCTL_HIRC_SEL_Pos)                /*!< CLK_T::PWRCTL: HIRC_SEL Mask           */
...
#define CLK_AHBCLK_GDMACKEN_Pos          (8)                                               /*!< CLK_T::AHBCLK: GDMACKEN Position       */
#define CLK_AHBCLK_GDMACKEN_Msk          (0x1ul << CLK_AHBCLK_GDMACKEN_Pos)                /*!< CLK_T::AHBCLK: GDMACKEN Mask           */
...
#define CLK_APBCLK_OPCKEN_Pos            (12)                                              /*!< CLK_T::APBCLK: OPCKEN Position         */
#define CLK_APBCLK_OPCKEN_Msk            (0x1ul << CLK_APBCLK_OPCKEN_Pos)                  /*!< CLK_T::APBCLK: OPCKEN Mask             */
...
#define CLK_APBCLK_USCI2CKEN_Pos         (26)                                              /*!< CLK_T::APBCLK: USCI2CKEN Position      */
#define CLK_APBCLK_USCI2CKEN_Msk         (0x1ul << CLK_APBCLK_USCI2CKEN_Pos)               /*!< CLK_T::APBCLK: USCI2CKEN Mask          */
...
#define CLK_STATUS_REXCLKSTB_Pos         (0)                                               /*!< CLK_T::STATUS: REXCLKSTB Position      */
#define CLK_STATUS_REXCLKSTB_Msk         (0x1ul << CLK_STATUS_REXCLKSTB_Pos)               /*!< CLK_T::STATUS: REXCLKSTB Mask          */
 ...
 * |        |          |Note2:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[16]    |DINOFF0   |Port A-F Pin[n] Digital Input Path Disable Control
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[17]    |DINOFF1   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[18]    |DINOFF2   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[19]    |DINOFF3   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[20]    |DINOFF4   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[21]    |DINOFF5   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[22]    |DINOFF6   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[23]    |DINOFF7   |Port A-F Pin[n] Digital Input Path Disable Control
 * |        |          |Each of these bits is used to control if the digital input path of corresponding Px.n pin is disabled
 * |        |          |If input is analog signal, users can disable Px.n digital input path to avoid input current leakage.
 * |        |          |0 = Px.n digital input path Enabled.
 * |        |          |1 = Px.n digital input path Disabled (digital input tied to low).
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |DATMSK1   |Port A-F Pin[n] Data Output Write Mask
 * |        |          |These bits are used to protect the corresponding DOUT (Px_DOUT[n]) bit
 * |        |          |When the DATMSK (Px_DATMSK[n]) bit is set to 1, the corresponding DOUT (Px_DOUT[n]) bit is protected
 * |        |          |If the write signal is masked, writing data to the protect bit is ignored.
 * |        |          |0 = Corresponding DOUT (Px_DOUT[n]) bit can be updated.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |DBEN0     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |DBEN1     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |DBEN2     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |DBEN3     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |DBEN4     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |DBEN5     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |DBEN6     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |DBEN7     |Port A-F Pin[n] Input Signal De-bounce Enable Control
 * |        |          |The DBEN[n] bit is used to enable the de-bounce function for each corresponding bit
 * |        |          |If the input signal pulse width cannot be sampled by continuous two de-bounce sample cycle, the input signal transition is seen as the signal bounce and will not trigger the interrupt
 * |        |          |The de-bounce clock source is controlled by DBCLKSRC (GPIO_DBCTL [4]), one de-bounce sample cycle period is controlled by DBCLKSEL (GPIO_DBCTL [3:0]).
 * |        |          |0 = Px.n de-bounce function Disabled.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |FLIEN0    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |FLIEN1    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |FLIEN2    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |FLIEN3    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |FLIEN4    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |FLIEN5    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |FLIEN6    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |FLIEN7    |Port A-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Control
 * |        |          |The FLIEN (Px_INTEN[n]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the FLIEN (Px_INTEN[n]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at low level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[16]    |RHIEN0    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[17]    |RHIEN1    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[18]    |RHIEN2    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[19]    |RHIEN3    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[20]    |RHIEN4    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[21]    |RHIEN5    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[22]    |RHIEN6    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[23]    |RHIEN7    |Port A-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Control
 * |        |          |The RHIEN (Px_INTEN[n+16]) bit is used to enable the interrupt for each of the corresponding input Px.n pin
 * |        |          |Set bit to 1 also enable the pin wake-up function.
 * |        |          |When setting the RHIEN (Px_INTEN[n+16]) bit to 1 :
 * |        |          |If the interrupt is level trigger (TYPE (Px_INTTYPE[n]) bit is set to 1), the input Px.n pin will generate the interrupt while this pin state is at high level.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |SMTEN0    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |SMTEN1    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |SMTEN2    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |SMTEN3    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |SMTEN4    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |SMTEN5    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |SMTEN6    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |SMTEN7    |Port A-F Pin[n] Input Schmitt Trigger Enable Control
 * |        |          |0 = Px.n input schmitt trigger function Disabled.
 * |        |          |1 = Px.n input schmitt trigger function Enabled.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |HSREN0    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |HSREN1    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |HSREN2    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |HSREN3    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |HSREN4    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |HSREN5    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |HSREN6    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |HSREN7    |Port A-F Pin[n] High Slew Rate Control
 * |        |          |0 = Px.n output with basic slew rate.
 * |        |          |1 = Px.n output with higher slew rate.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |PLEN0     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |PLEN1     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |PLEN2     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |PLEN3     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |PLEN4     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |PLEN5     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |PLEN6     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |PLEN7     |Port A-F Pull-low Resistor Control
 * |        |          |0 = Pull-Low Resistor Disabled.
 * |        |          |1 = Pull-Low Resistor Enabled.
 * |        |          |Note: The initial value of PA_PLEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |PHEN0     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 * |        |          |Note:
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[1]     |PHEN1     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[2]     |PHEN2     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[3]     |PHEN3     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[4]     |PHEN4     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[5]     |PHEN5     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[6]     |PHEN6     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
 ...
 * |        |          |Max. n=7 for port A~E, , but n=0 is reserved in port D.
 * |        |          |Max. n=4 for port F.
 * |[7]     |PHEN7     |Port A-F Pull-high Resistor Control
 * |        |          |0 = Pull-High Resistor Enabled.
 * |        |          |1 = Pull-High Resistor Disabled.
 * |        |          |Note: The initial value of PA_PHEN were defined by GPAn_RINI (CONFIG0[27:16])
 * |        |          |Selected pins will be configured after chip powered on.
...
#define GPIO_PLEN_PX_PLEN0_Pos           (0)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN0 Position           */
#define GPIO_PLEN_PX_PLEN0_Msk           (0x1ul << GPIO_PLEN_PX_PLEN0_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN0 Mask               */

#define GPIO_PLEN_PX_PLEN1_Pos           (1)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN1 Position           */
#define GPIO_PLEN_PX_PLEN1_Msk           (0x1ul << GPIO_PLEN_PX_PLEN1_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN1 Mask               */

#define GPIO_PLEN_PX_PLEN2_Pos           (2)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN2 Position           */
#define GPIO_PLEN_PX_PLEN2_Msk           (0x1ul << GPIO_PLEN_PX_PLEN2_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN2 Mask               */

#define GPIO_PLEN_PX_PLEN3_Pos           (3)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN3 Position           */
#define GPIO_PLEN_PX_PLEN3_Msk           (0x1ul << GPIO_PLEN_PX_PLEN3_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN3 Mask               */

#define GPIO_PLEN_PX_PLEN4_Pos           (4)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN4 Position           */
#define GPIO_PLEN_PX_PLEN4_Msk           (0x1ul << GPIO_PLEN_PX_PLEN4_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN4 Mask               */

#define GPIO_PLEN_PX_PLEN5_Pos           (5)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN5 Position           */
#define GPIO_PLEN_PX_PLEN5_Msk           (0x1ul << GPIO_PLEN_PX_PLEN5_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN5 Mask               */

#define GPIO_PLEN_PX_PLEN6_Pos           (6)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN6 Position           */
#define GPIO_PLEN_PX_PLEN6_Msk           (0x1ul << GPIO_PLEN_PX_PLEN6_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN6 Mask               */

#define GPIO_PLEN_PX_PLEN7_Pos           (7)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN7 Position           */
#define GPIO_PLEN_PX_PLEN7_Msk           (0x1ul << GPIO_PLEN_PX_PLEN7_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PLEN: PLEN7 Mask               */

#define GPIO_PHEN_PX_PHEN0_Pos           (0)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN0 Position           */
#define GPIO_PHEN_PX_PHEN0_Msk           (0x1ul << GPIO_PHEN_PX_PHEN0_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN0 Mask               */

#define GPIO_PHEN_PX_PHEN1_Pos           (1)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN1 Position           */
#define GPIO_PHEN_PX_PHEN1_Msk           (0x1ul << GPIO_PHEN_PX_PHEN1_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN1 Mask               */

#define GPIO_PHEN_PX_PHEN2_Pos           (2)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN2 Position           */
#define GPIO_PHEN_PX_PHEN2_Msk           (0x1ul << GPIO_PHEN_PX_PHEN2_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN2 Mask               */

#define GPIO_PHEN_PX_PHEN3_Pos           (3)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN3 Position           */
#define GPIO_PHEN_PX_PHEN3_Msk           (0x1ul << GPIO_PHEN_PX_PHEN3_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN3 Mask               */

#define GPIO_PHEN_PX_PHEN4_Pos           (4)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN4 Position           */
#define GPIO_PHEN_PX_PHEN4_Msk           (0x1ul << GPIO_PHEN_PX_PHEN4_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN4 Mask               */

#define GPIO_PHEN_PX_PHEN5_Pos           (5)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN5 Position           */
#define GPIO_PHEN_PX_PHEN5_Msk           (0x1ul << GPIO_PHEN_PX_PHEN5_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN5 Mask               */

#define GPIO_PHEN_PX_PHEN6_Pos           (6)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN6 Position           */
#define GPIO_PHEN_PX_PHEN6_Msk           (0x1ul << GPIO_PHEN_PX_PHEN6_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN6 Mask               */

#define GPIO_PHEN_PX_PHEN7_Pos           (7)                                               /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN7 Position           */
#define GPIO_PHEN_PX_PHEN7_Msk           (0x1ul << GPIO_PHEN_PX_PHEN7_Pos)                 /*!< GPIO_T::PA/PB/PC/PD/PE/PF_PHEN: PHEN7 Mask               */
 ...
 * |        |          |00 = The timer is operating in One-shot mode
 ...
 * |        |          |Please refer to 6.6.5.6 for detailed description about Continuous Counting mode operation.
 ...
 * |        |          |This bit indicates the detection phase of TMx (x = 0~2) pin.
 * |        |          |0 = A falling edge of TMx (x = 0~2) pin will be counted.
 * |        |          |1 = A rising edge of TMx (x = 0~2) pin will be counted.
 * |[2:1]   |CAPEDGE   |Timer Capture Pin Edge Detection
 * |        |          |00 = A falling edge on ACMP_CO0 will be detected.
 * |        |          |01 = A rising edge on ACMP_CO0 will be detected.
 * |        |          |10 = Either rising or falling edge on ACMP_CO0 will be detected.
 * |        |          |11 = Reserved.
 * |[3]     |CAPEN     |Timer Capture Function Enable Control
 ...
 * |[5]     |CAPIEN    |Timer Capture Interrupt Enable Control
 ...
 * |        |          |For example, while CAPIEN = 1, CAPEN = 1, and CAPEDGE = 00, an 1 to 0 transition on the ACMP_COx will cause the CAPIF to be set then the interrupt signal is generated and sent to NVIC to inform CPU.
 * |[7]     |ECNTDBEN  |Timer Counter Input Pin De-bounce Enable Control
 * |        |          |0 = TMx (x = 0~2) pin de-bounce Disabled.
 * |        |          |1 = TMx (x = 0~2) pin de-bounce Enabled.
 * |        |          |If this bit is enabled, the edge detection of TMx (x = 0~2) pin is detected with de-bounce circuit.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |CCAPEN    |Continuous Capture Enable Control
 * |        |          |This bit is to be enabled the continuous capture function.
 * |        |          |0 = Continuous capture function Disabled.
 * |        |          |1 = Continuous capture function Enabled.
 ...
 * |        |          |0 = None.
 * |        |          |1 = CAPDAT(TIMER_CCAP1[23:0]) data is ready for read.
 * |        |          |Note: This bit is cleared by hardware automatically when writing 1 to this bit.
 * |[10]    |CAPR2F    |Capture Rising Edge 2 Flag
 * |        |          |Second rising edge already captured, this bit will be set to 1.
 * |        |          |0 = None.
 * |        |          |1 = CAPDAT(TIMER_CCAP2[23:0]) data is ready for read.
 * |        |          |Note: This bit is cleared by hardware automatically when writing 1 to this bit.
 * |[11]    |CAPF2F    |Capture Falling Edge 2 Flag
 * |        |          |Second falling edge already captured, this bit will be set to 1
 * |        |          |0 = None.
 * |        |          |1 = CAPDAT(TIMER_CCAP3[23:0]) data is ready for read.
 * |        |          |Note: This bit is cleared by hardware automatically when writing 1 to this bit.
 * |[17:16] |CCAPIEN   |Capture Interrupt Enable Control
 * |        |          |00 = Interrupt Disabled.
 * |        |          |01 = Capture Rising Edge 1 and Falling Edge 1 interrupt Enabled.
 * |        |          |10 = Capture Rising Edge 1, Falling dege1 and Rising Edge 2 interrupt Enabled.
 * |        |          |11 = Capture Rising Edge 1, Falling dege1, Rising Edge 2 and Falling Edge 2 interrupt Enabled.
 * |[24]    |NFDIS     |Disable Input Capture Noise Filter
 * |        |          |0 = Noise filter of Input Capture Enabled.
 * |        |          |1 = The noise filter of Input Capture Disabled.
 * |[26:25] |NFCLKS    |Noise Filter Clock Pre-divided Selection
 ...
 * |        |          |11 = CAPCLK / 16. 
 * @var TIMER_AC_T::CCAP
 * Offset: 0x44  Timer Continuous Capture Data Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 */
    ...
    __I  uint32_t CCAP[4];               /*!< [0x0044] Timer Continuous Capture Data Register 0/1/2/3                   */
...
#define TIMER_CCAPCTL_CNTSEL2_Pos         (5)                                                /*!< TIMER_AC_T::CCAPCTL: CNTSEL Position        */
#define TIMER_CCAPCTL_CNTSEL2_Msk         (0x7ul << TIMER_CCAPCTL_CNTSEL2_Pos)               /*!< TIMER_AC_T::CCAPCTL: CNTSEL Mask            */
...
#define TIMER_CCAPCTL_NFDIS_Pos            (24)                                              /*!< TIMER_AC_T::CCAPCTL: NFDIS Position         */
#define TIMER_CCAPCTL_NFDIS_Msk            (0x1ul << TIMER_CCAPCTL_NFDIS_Pos)                /*!< TIMER_AC_T::CCAPCTL: NFDIS Mask             */

#define TIMER_CCAPCTL_NFCLKS_Pos           (25)                                              /*!< TIMER_AC_T::CCAPCTL: NFCLKS Position        */
#define TIMER_CCAPCTL_NFCLKS_Msk           (0x3ul << TIMER_CCAPCTL_NFCLKS_Pos)               /*!< TIMER_AC_T::CCAPCTL: NFCLKS Mask            */
 ...
 * |        |          |The clock source for the counter is from the clock divider output which the ECAP_CLK is divided by 1, 4, 16, 32, 64, 96, 112 or 128.
 * @var ECAP_T::HLD
 * Offset: 0x04  Input Capture Counter Hold Register 0/1/2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Each input channel has itself holding register named by ECAP_HLDx where x is from 0 to 2 to indicate inputs from IC0 to IC2, respectively.
 * @var ECAP_T::CNTCMP
 ...
 * |        |          |If the compare function is enabled (CMPEN = 1), the compare register is loaded with the value that the compare function compares the capture counter (ECAP_CNT).
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[2:0]   |NFCLKS    |Noise Filter Clock Pre-divided Selection
 * |        |          |To determine the sampling frequency of the Noise Filter clock
 * |        |          |000 = ECAP_CLK.
 * |        |          |001 = ECAP_CLK / 2.
 * |        |          |010 = ECAP_CLK / 4.
 ...
 * |[9:8]   |CAP0SEL   |CAP0 Input Source Selection
 * |        |          |00 = CAP0 input is from port pin ECAP_P0.
 * |        |          |01 = CAP0 input is from signal ACMP_CO0 (Analog comparator 0 output).
 * |        |          |10 = CAP0 input is from signal ACMP_CO0 (Analog comparator 0 output).
 * |        |          |11 = Reserved
 * |[11:10] |CAP1SEL   |CAP1 Input Source Selection
 * |        |          |00 = CAP1 input is from port pin ECAP_P1.
 * |        |          |01 = CAP1 input is from signal ACMP_CO0 (Analog comparator 0 output).
 * |        |          |10 = CAP1 input is from signal ACMP_CO0 (Analog comparator 0 output).
 * |        |          |11 = Reserved
 * |[13:12] |CAP2SEL   |CAP2 Input Source Selection
 * |        |          |00 = CAP2 input is from port pin ECAP_P2.
 * |        |          |01 = CAP2 input is from signal ACMP_CO0 (Analog comparator 0 output).
 * |        |          |10 = CAP2 input is from signal ACMP_CO0 (Analog comparator 0 output).
 * |        |          |11 =Reserved
 ...
 * |[25]    |CMPCLR    |Input Capture Counter Clear by Compare-match Control
 ...
 * |[26]    |CPTCLR    |Input Capture Counter Clear by Capture Events Control
 ...
 * |[27]    |RLDEN     |The Reload Function Enable Control
 ...
 * |[28]    |CMPEN     |The Compare Function Enable Control
 ...
 * |[30]    |CAPPHGEN  |Input Capture Flag Trigger PWM Phase Change Function Enable Control
 ...
 * |        |          |110 = ECAP_CLK / 112.
 * |        |          |111 = ECAP_CLK / 128.
 * |[17:16] |CNTSRC    |Capture Timer/Counter Clock Source Selection
 ...
 * |        |          |1 = CNT overflows.
 * |        |          |Note: This bit is only cleared by writing 1 to itself through software.
 * |[8]     |CAP0      |Input Capture Source 0 Status (Read Only)
 * |        |          |Input capture Source 0 (CAP0) status. It is read only.
 * |        |          |(The bit is read only and write is ignored)
 * |[9]     |CAP1      |Input Capture Source 1 Status (Read Only)
 * |        |          |Input capture Source 1 (CAP1) status. It is read only.
 * |        |          |(The bit is read only and write is ignored)
 * |[10]    |CAP2      |Input Capture Source 2 Status (Read Only)
 * |        |          |Input captureSource 2 (CAP2) status. It is read only.
 * |        |          |(The bit is read only and write is ignored)
 * @var ECAP_T::CTL2
 * Offset: 0x20  Input Capture Control Register 2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |RLDS0EN   |CATF0 Event Trigger Enable For RLD event Source
 * |        |          |0 = Disabling flag CAPTF0 can trigger RLD function
 * |        |          |1 = Enabling flag CAPTF0 can trigger RLD function
 * |[1]     |RLDS1EN   |CAPTF1 Event Trigger Enable For RLD event Source
 * |        |          |0 = Disabling flag CAPTF1 can trigger RLD function
 * |        |          |1 = Enabling flag CAPTF1 can trigger RLD function
 * |[2]     |RLDS2EN   |CAPTF2 Event Trigger Enable For RLD event Source
 * |        |          |0 = Disabling flag CAPTF2 can trigger RLD function
 * |        |          |1 = Enabling flag CAPTF2 can trigger RLD function
 * |[3]     |RLDOVSEN  |CAPOVF Event Trigger Enable For RLD event Source
 * |        |          |0 = Disabling flag CAPOVF can trigger RLD function
 * |        |          |1 = Enabling flag CAPOVF can trigger RLD function
 * |[4]     |RLDMS     |Mode Selection Of RLD Function Trigger Event Source
 * |        |          |0 = RLD event source in normal mode
 * |        |          |1 = RLD event source in enhanced mode
 * |[8]     |CLRS0EN   |CAPTF0 Event Trigger Enable For CPTCLR event Source
 * |        |          |0 = Disabling flag CAPTF0 can trigger CPTCLR function
 * |        |          |1 = Enabling flag CAPTF0 can trigger CPTCLR function
 * |[9]     |CLRS1EN   |CAPTF1 Event Trigger Enable For CPTCLR event Source
 * |        |          |0 = Disabling flag CAPTF1 can trigger CPTCLR function
 * |        |          |1 = Enabling flag CAPTF1 can trigger CPTCLR function
 * |[10]    |CLRS2EN   |CAPTF2 Event Trigger Enable For CPTCLR event Source
 * |        |          |0 = Disabling flag CAPTF2 can trigger CPTCLR.function
 * |        |          |1 = Enabling flag CAPTF2 can trigger CPTCLR.function
 * |[12]    |CPTCLRMS  |Mode Selection Of CPTCLR Function Trigger Event Source
 * |        |          |0 = CPTCLR event source in normal mode
 * |        |          |1 = CPTCLR event source in enhanced mode
 * @var ECAP_T::TST
 * Offset: 0x28  Input Capture Testmode Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31]    |CHEAT     |ECAP CHEAT MODE (Write Protect)
 * |        |          |0: The input Capture Timer/Counter is incremented by 24’d1.
 * |        |          |1: The input Caputre Timer/Counter is incremented by 24’d255.
 */
    __IO uint32_t CNT;                   /*!< [0x0000] Input Capture Counter                                            */
    __IO uint32_t HLD[3];                /*!< [0x0004] Input Capture Counter Hold Register 0/1/2                        */
    ...
    __IO uint32_t CTL2;                  /*!< [0x0020] Input Capture Control Register 2                                 */
    __I  uint32_t RESERVE[1];
    __IO uint32_t TST;                   /*!< [0x0028] Input Capture Testmode Register                                  */
...
#define ECAP_CTL0_NFCLKS_Msk             (0x7ul << ECAP_CTL0_NFCLKS_Pos)                   /*!< ECAP_T::CTL0: NFCLKS Mask              */
...
#define ECAP_STS_CAP0_Pos                (8)                                               /*!< ECAP_T::STS: CAP0 Position             */
#define ECAP_STS_CAP0_Msk                (0x1ul << ECAP_STS_CAP0_Pos)                      /*!< ECAP_T::STS: CAP0 Mask                 */

#define ECAP_STS_CAP1_Pos                (9)                                               /*!< ECAP_T::STS: CAP1 Position             */
#define ECAP_STS_CAP1_Msk                (0x1ul << ECAP_STS_CAP1_Pos)                      /*!< ECAP_T::STS: CAP1 Mask                 */

#define ECAP_STS_CAP2_Pos                (10)                                              /*!< ECAP_T::STS: CAP2 Position             */
#define ECAP_STS_CAP2_Msk                (0x1ul << ECAP_STS_CAP2_Pos)                      /*!< ECAP_T::STS: CAP2 Mask                 */

#define ECAP_CTL2_RLDS0EN_Pos            (0)                                               /*!< ECAP_T::CTL2: RLDS0EN Position         */
#define ECAP_CTL2_RLDS0EN_Msk            (0x1ul << ECAP_CTL2_RLDS0EN_Pos)                  /*!< ECAP_T::CTL2: RLDS0EN Mask             */

#define ECAP_CTL2_RLDS1EN_Pos            (1)                                               /*!< ECAP_T::CTL2: RLDS1EN Position         */
#define ECAP_CTL2_RLDS1EN_Msk            (0x1ul << ECAP_CTL2_RLDS1EN_Pos)                  /*!< ECAP_T::CTL2: RLDS1EN Mask             */

#define ECAP_CTL2_RLDS2EN_Pos            (2)                                               /*!< ECAP_T::CTL2: RLDS2EN Position         */
#define ECAP_CTL2_RLDS2EN_Msk            (0x1ul << ECAP_CTL2_RLDS2EN_Pos)                  /*!< ECAP_T::CTL2: RLDS2EN Mask             */

#define ECAP_CTL2_RLDOVSEN_Pos           (3)                                               /*!< ECAP_T::CTL2: RLDOVSEN Position        */
#define ECAP_CTL2_RLDOVSEN_Msk           (0x1ul << ECAP_CTL2_RLDOVSEN_Pos)                 /*!< ECAP_T::CTL2: RLDOVSEN Mask            */

#define ECAP_CTL2_RLDMS_Pos              (4)                                               /*!< ECAP_T::CTL2: RLDMS Position           */
#define ECAP_CTL2_RLDMS_Msk              (0x1ul << ECAP_CTL2_RLDMS_Pos)                    /*!< ECAP_T::CTL2: RLDMS Mask               */

#define ECAP_CTL2_CLRS0EN_Pos            (8)                                               /*!< ECAP_T::CTL2: CLRS0EN Position         */
#define ECAP_CTL2_CLRS0EN_Msk            (0x1ul << ECAP_CTL2_CLRS0EN_Pos)                  /*!< ECAP_T::CTL2: CLRS0EN Mask             */

#define ECAP_CTL2_CLRS1EN_Pos            (9)                                               /*!< ECAP_T::CTL2: CLRS1EN Position         */
#define ECAP_CTL2_CLRS1EN_Msk            (0x1ul << ECAP_CTL2_CLRS1EN_Pos)                  /*!< ECAP_T::CTL2: CLRS1EN Mask             */

#define ECAP_CTL2_CLRS2EN_Pos            (10)                                              /*!< ECAP_T::CTL2: CLRS2EN Position         */
#define ECAP_CTL2_CLRS2EN_Msk            (0x1ul << ECAP_CTL2_CLRS2EN_Pos)                  /*!< ECAP_T::CTL2: CLRS2EN Mask             */

#define ECAP_CTL2_CPTCLRMS_Pos           (12)                                              /*!< ECAP_T::CTL2: CPTCLRMS Position        */
#define ECAP_CTL2_CPTCLRMS_Msk           (0x1ul << ECAP_CTL2_CPTCLRMS_Pos)                 /*!< ECAP_T::CTL2: CPTCLRMS Mask            */

#define ECAP_TST_CHEAT_Pos               (31)                                              /*!< ECAP_T::TST: CHEAT Position            */
#define ECAP_TST_CHEAT_Msk               (0x1ul << ECAP_TST_CHEAT_Pos)                     /*!< ECAP_T::TST: CHEAT Mask                */
 ...
 * |        |          |1 = WDT Enabled.
 * |[10:8]  |TOUTSEL   |Watchdog Timer Interval Selection(Write Protect)
 ...
 * |        |          |110 = 2^16 * TWDT.
 * |        |          |111 = 2^18 * TWDT.
 * |[12]    |WTTOF     |Watchdog Timer Time-out Flag
...
#define WDT_CTL_WTTOF_Pos                (12)                                              /*!< WDT_T::CTL: WTTOF Position             */
#define WDT_CTL_WTTOF_Msk                (0x1ul << WDT_CTL_WTTOF_Pos)                      /*!< WDT_T::CTL: WTTOF Mask                 */
 ...
 * @var UUART_T::DMACTL
 * Offset: 0x40  USCI DMA Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |DMARST    |DMA Reset
 * |        |          |0 = No effect.
 * |        |          |1 = Reset the USCI’s DMA control logic. This bit will be cleared to 0 automatically.
 * |[1]     |TXDMAEN   |DMA Transmit Channel Available
 * |        |          |0 = Transmit DMA function Disabled.
 * |        |          |1 = Transmit DMA function Enabled.
 * |[2]     |RXDMAEN   |DMA Receive Channel Available
 * |        |          |0 = Receive DMA function Disabled.
 * |        |          |1 = Receive DMA function Enabled.
 * |[3]     |DMAEN    |DMA Mode Enable Bit
 ...
 */
    ...
    __IO uint32_t BUFSTS;                /*!< [0x003c] USCI Transmit/Receive Buffer Status Register                     */
  	__IO uint32_t DMACTL; 				       /*!< [0x0040] USCI DMA Control Register                   				              */
...
#define UUART_DMACTL_DMARST_Pos          (0)                                               /*!< UUART_T::DMACTL: DMARST Position       */
#define UUART_DMACTL_DMARST_Msk      	   (0x1ul << UUART_DMACTL_DMARST_Pos)                /*!< UUART_T::DMACTL: DMARST Mask           */

#define UUART_DMACTL_TXDMAEN_Pos         (1)                                               /*!< UUART_T::DMACTL: TXDMAEN_ Position     */
#define UUART_DMACTL_TXDMAEN_Msk         (0x1ul << UUART_DMACTL_TXDMAEN_Pos)               /*!< UUART_T::DMACTL: TXDMAEN_ Mask         */

#define UUART_DMACTL_RXDMAEN_Pos         (2)                                               /*!< UUART_T::DMACTL: RXDMAEN Position      */
#define UUART_DMACTL_RXDMAEN_Msk         (0x1ul << UUART_DMACTL_RXDMAEN_Pos)               /*!< UUART_T::DMACTL: RXDMAEN Mask          */

#define UUART_DMACTL_DMAEN_Pos           (3)                                               /*!< UUART_T::DMACTL: DMAEN Position        */
#define UUART_DMACTL_DMAEN_Msk           (0x1ul << UUART_DMACTL_DMAEN_Pos)                 /*!< UUART_T::DMACTL: DMAEN Mask            */
 ...
 * |[25:16] |CLKDIV    |Clock Divider
 * |        |          |This bit field defines the ratio between the protocol clock frequency fPROT_CLK and the clock divider frequency fDIV_CLK (fDIV_CLK = fPROT_CLK / (CLKDIV+1) ).
 * |        |          |Note: For I2C function, the minimum value of CLKDIV is 8. Reserved.
 * @var USPI_T::DATIN0
 * Offset: 0x10  USCI Input Data Signal Configuration Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 ...
 * |[15:0]  |TXDAT     |Transmit Data
 * |        |          |Software can use this bit field to write 16-bit transmit data for transmission.
 * |        |          |To avoid overwriting the transmit data, user have to check TXEMPTY (USPI_BUFSTS[8]) status before writing transmit data into this bit field.
 * @var USPI_T::RXDAT
 * Offset: 0x34  USCI Receive Data Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
...
#define USPI_DMACTL_DMARST_Pos           (0)                                               /*!< USPI_T::DMACTL: DMARST Position        */
#define USPI_DMACTL_DMARST_Msk           (0x1ul << USPI_DMACTL_DMARST_Pos)                 /*!< USPI_T::DMACTL: DMARST Mask            */

#define USPI_DMACTL_TXDMAEN_Pos          (1)                                               /*!< USPI_T::DMACTL: TXDMAEN_ Position      */
#define USPI_DMACTL_TXDMAEN_Msk          (0x1ul << USPI_DMACTL_TXDMAEN_Pos)                /*!< USPI_T::DMACTL: TXDMAEN_ Mask          */

#define USPI_DMACTL_RXDMAEN_Pos          (2)                                               /*!< USPI_T::DMACTL: RXDMAEN Position       */
#define USPI_DMACTL_RXDMAEN_Msk          (0x1ul << USPI_DMACTL_RXDMAEN_Pos)                /*!< USPI_T::DMACTL: RXDMAEN Mask           */

#define USPI_DMACTL_DMAEN_Pos            (3)                                               /*!< USPI_T::DMACTL: DMAEN Position         */
#define USPI_DMACTL_DMAEN_Msk            (0x1ul << USPI_DMACTL_DMAEN_Pos)                  /*!< USPI_T::DMACTL: DMAEN Mask             */
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |TXDAT     |Transmit Data
 * |        |          |Software can use this bit field to write 16-bit transmit data for transmission.
 * |[14]    |DMASTO    |I2C STOP Control(for DMA only)
 ...
 * |[15]    |DMASTA    |I2C START Control(for DMA only)
 ...
 * |        |          |0 = DMA function Disabled.
 * |        |          |1 = DMA function Enabled.
 * |[4]     |NACKEN    |1: When finish of RXDAM in slave mode, hardware will auto NACK the last byte.
 * |[5]     |STOPEN    |1: When finish of RXDAM in master mode, hardware will auto generate STOP condition
 * @var UI2C_T::DEVADDR0
 ...
 * |        |          |If the first   received address byte is b1111 0AAX, the AA bits are compared to the bits DEVADDR[9:8] to   check for address match, where the X is R/W bit
 ...
 * |        |          |0 = The chip is woken up according to data toggle.
 ...
 */
    ...
    __I  uint32_t RXDAT;                 /*!< [0x0034] USCI Receive Data Register                                       */
    __I  uint32_t RESERVE2[1];
		__I  uint32_t BUFSTS;                /*!< [0x003C] USCI Transmit/Receive Buffer Status Register                     */
    __IO uint32_t DMACTL; 				 			 /*!< [0x0040] USCI DMA Control Register                   				  					  */
...
#define UI2C_TXDAT_TXDAT_Msk             (0xfful << UI2C_TXDAT_TXDAT_Pos)                  /*!< UI2C_T::TXDAT: TXDAT Mask              */

#define UI2C_TXDAT_DMASTO_Pos            (14)                                              /*!< UI2C_T::TXDAT: DMASTO Position         */
#define UI2C_TXDAT_DMASTO_Msk            (0x1ul << UI2C_TXDAT_DMASTO_Pos)                	 /*!< UI2C_T::TXDAT: DMASTO Mask             */

#define UI2C_TXDAT_DMASTA_Pos            (15)                                              /*!< UI2C_T::TXDAT: DMASTA Position         */
#define UI2C_TXDAT_DMASTA_Msk            (0x1ul << UI2C_TXDAT_DMASTA_Pos)                  /*!< UI2C_T::TXDAT: DMASTA Mask             */
...
#define UI2C_BUFSTS_TXFULL_Pos           (9)                                               /*!< UI2C_T::BUFSTS: TXFULL Position        */
#define UI2C_BUFSTS_TXFULL_Msk           (0x1ul << UI2C_BUFSTS_TXFULL_Pos)                 /*!< UI2C_T::BUFSTS: TXFULL Mask            */

#define UI2C_BUFSTS_TXEMPTY_Pos          (8)                                               /*!< UI2C_T::BUFSTS: TXEMPTY Position       */
#define UI2C_BUFSTS_TXEMPTY_Msk          (0x1ul << UI2C_BUFSTS_TXEMPTY_Pos)                /*!< UI2C_T::BUFSTS: TXEMPTY Mask           */

#define UI2C_BUFSTS_RXFULL_Pos           (1)                                               /*!< UI2C_T::BUFSTS: RXFULL Position        */
#define UI2C_BUFSTS_RXFULL_Msk           (0x1ul << UI2C_BUFSTS_RXFULL_Pos)                 /*!< UI2C_T::BUFSTS: RXFULL Mask            */

#define UI2C_BUFSTS_RXEMPTY_Pos          (0)                                               /*!< UI2C_T::BUFSTS: RXEMPTY Position       */
#define UI2C_BUFSTS_RXEMPTY_Msk          (0x1ul << UI2C_BUFSTS_RXEMPTY_Pos)                /*!< UI2C_T::BUFSTS: RXEMPTY Mask           */

#define UI2C_DMACTL_DMARST_Pos           (0)                                               /*!< UI2C_T::DMACTL: DMARST Position        */
#define UI2C_DMACTL_DMARST_Msk           (0x1ul << UI2C_DMACTL_DMARST_Pos)                 /*!< UI2C_T::DMACTL: DMARST Mask            */

#define UI2C_DMACTL_TXDMAEN_Pos          (1)                                               /*!< UI2C_T::DMACTL: TXDMAEN_ Position      */
#define UI2C_DMACTL_TXDMAEN_Msk          (0x1ul << UI2C_DMACTL_TXDMAEN_Pos)                /*!< UI2C_T::DMACTL: TXDMAEN_ Mask          */

#define UI2C_DMACTL_RXDMAEN_Pos          (2)                                               /*!< UI2C_T::DMACTL: RXDMAEN Position       */
#define UI2C_DMACTL_RXDMAEN_Msk          (0x1ul << UI2C_DMACTL_RXDMAEN_Pos)                /*!< UI2C_T::DMACTL: RXDMAEN Mask           */

#define UI2C_DMACTL_DMAEN_Pos            (3)                                               /*!< UI2C_T::DMACTL: DMAEN Position         */
#define UI2C_DMACTL_DMAEN_Msk            (0x1ul << UI2C_DMACTL_DMAEN_Pos)                  /*!< UI2C_T::DMACTL: DMAEN Mask             */

#define UI2C_DMACTL_NACKEN_Pos           (4)                                               /*!< UI2C_T::DMACTL: NACKEN Position        */
#define UI2C_DMACTL_NACKEN_Msk           (0x1ul << UI2C_DMACTL_NACKEN_Pos)                 /*!< UI2C_T::DMACTL: NACKEN Mask            */

#define UI2C_DMACTL_STOPEN_Pos           (5)                                               /*!< UI2C_T::DMACTL: STOPEN Position        */
#define UI2C_DMACTL_STOPEN_Msk           (0x1ul << UI2C_DMACTL_STOPEN_Pos)                 /*!< UI2C_T::DMACTL: STOPEN Mask            */
...
/**
 * @var HDIV_STS_T::STATUS
 * Offset: 0x00  Divider Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[1]     |DIVBYZERO0|Divisor 0 Zero Warning
 * |        |          |0 = The divisor is not 0.
 * |        |          |1 = The divisor is 0.
 * |        |          |Note: The DIVBYZERO0 flag is used to indicate divide-by-zero situation and updated whenever HDIV_DIVISOR is written
 * |        |          |This register is read only
 * |[2]     |DIVBYZERO1|Divisor 1 Zero Warning
 * |        |          |0 = The divisor is not 0.
 * |        |          |1 = The divisor is 0.
 * |        |          |Note: The DIVBYZERO1 flag is used to indicate divide-by-zero situation and updated whenever HDIV_DIVISOR is written
 * |        |          |This register is read only
 * |[3]     |DIVBYZERO2|Divisor 2 Zero Warning
 * |        |          |0 = The divisor is not 0.
 * |        |          |1 = The divisor is 0.
 * |        |          |Note: The DIVBYZERO2 flag is used to indicate divide-by-zero situation and updated whenever HDIV_DIVISOR is written
 * |        |          |This register is read only
 */
    __I  uint32_t STATUS;                /*!< [0x0000] Divider Status Register                                          */
...
#define HDIV_STATUS_DIVBYZERO0_Pos       (1)                                               /*!< HDIV_T::STATUS: DIVBYZERO0 Position    */
#define HDIV_STATUS_DIVBYZERO0_Msk       (0x1ul << HDIV_STATUS_DIVBYZERO0_Pos)             /*!< HDIV_T::STATUS: DIVBYZERO0 Mask        */

#define HDIV_STATUS_DIVBYZERO1_Pos       (2)                                               /*!< HDIV_T::STATUS: DIVBYZERO1 Position    */
#define HDIV_STATUS_DIVBYZERO1_Msk       (0x1ul << HDIV_STATUS_DIVBYZERO1_Pos)             /*!< HDIV_T::STATUS: DIVBYZERO1 Mask        */

#define HDIV_STATUS_DIVBYZERO2_Pos       (3)                                               /*!< HDIV_T::STATUS: DIVBYZERO2 Position    */
#define HDIV_STATUS_DIVBYZERO2_Msk       (0x1ul << HDIV_STATUS_DIVBYZERO2_Pos)             /*!< HDIV_T::STATUS: DIVBYZERO2 Mask        */
 ...
 * |[22]    |DBG_PWMOFF|PWM Debug Mode Configuration Bit (Available in DEBUG Mode Only)
 * |        |          |0 = Normal mode: PWM output keep in normal output mode.
 * |        |          |1 = Safe mode: PWM outputswill  keep in  tri-state .
 * |[23]    |DBGPWMEN  |PWM Debug Mode Configuration Bit (Available in DEBUG Mode Only)
 * |        |          |0 = Safe mode: The PWM  timer will stop counting when uc stop and output tr-istate. 
 * |        |          |1 = Normal mode: The PWM timer keep to counting when uC stop.
 ...
 * |[31]    |CNTTYPE   |PWM Aligned Type Selection
 * |        |          |0 = Edge-aligned type.
 ...
 * @var EPWM_T::CMPDAT
 * Offset: 0x24  EPWM Comparator Register 0/1/2/3/4/5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |0 = PWM counter is down counting.
 * |        |          |1 = PWM counter is up counting.
 * @var EPWM_T::INTEN
 * Offset: 0x54  EPWM Interrupt Enable Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |PIEN      |PWM Channel 0 Period Interrupt Enable Control
 * |        |          |for Edge-aligned and Center-aligned
 * |        |          |0 = EPWM Period interruptDisabled .
 * |        |          |1 = EPWM Period interruptEnabled .
 * |[8]     |CMPUIEN0  |PWM Channel 0 UP Interrupt Enable Control
 * |        |          |UP for Center-aligned only
 * |        |          |0 = EPWM_CH0 PWM UP counter reaches EPWM_CMPDAT0 interruptDisabled.
 * |        |          |1 = EPWM_CH0 PWM UP counter reaches EPWM_CMPDAT0 interruptEnabled.
 * |[9]     |CMPUIEN1  |PWM Channel 1 UP Interrupt Enable Control
 * |        |          |UP for Center-aligned only
 * |        |          |0 = EPWM_CH1 PWM UP counter reaches EPWM_CMPDAT1 interruptDisabled.
 * |        |          |1 = EPWM_CH1 PWM UP counter reaches EPWM_CMPDAT1 interruptEnabled.
 * |[10]    |CMPUIEN2  |PWM Channel 2 UP Interrupt Enable Control
 * |        |          |UP for Center-aligned only
 * |        |          |0 = EPWM_CH2 PWM UP counter reaches EPWM_CMPDAT2 interruptDisabled.
 * |        |          |1 = EPWM_CH2 PWM UP counter reaches EPWM_CMPDAT2 interruptEnabled.
 * |[11]    |CMPUIEN3  |PWM Channel 3 UP Interrupt Enable Control
 * |        |          |UP for Center-aligned only
 * |        |          |0 = EPWM_CH3 PWM UP counter reaches EPWM_CMPDAT3 interruptDisabled.
 * |        |          |1 = EPWM_CH3 PWM UP counter reaches EPWM_CMPDAT3 interruptEnabled.
 * |[12]    |CMPUIEN4  |PWM Channel 4 UP Interrupt Enable Control
 * |        |          |UP for Center-aligned only
 * |        |          |0 = EPWM_CH4 PWM UP counter reaches EPWM_CMPDAT4 interrupt Disabled.
 * |        |          |1 = EPWM_CH4 PWM UP counter reaches EPWM_CMPDAT4 interrupt Enabled.
 * |[13]    |CMPUIEN5  |PWM Channel 5 UP Interrupt Enable Control
 * |        |          |UP for Center-aligned only
 * |        |          |0 = PWM Channel 5 UP Interrupt Disabled.
 * |        |          |1 = Interruptwhen EPWM_CH5 PWM UP counter reaches EPWM_CMPDAT5 Enabled.
 * |[16]    |BRK0IEN   |Fault Brake0 Interrupt Enable Control
 * |        |          |0 = BRK0IF trigger PWM interrupt Disabled.
 * |        |          |1 = BRK0IF trigger PWM interrupt Enabled.
 * |[17]    |BRK1IEN   |Fault Brake1 Interrupt Enable Control
 * |        |          |0 = BRK1IF trigger PWM interrupt Disabed.
 * |        |          |1 = BRK1IF trigger PWM interrupt Enabled .
 * |[18]    |CIEN      |PWM Central Interrupt Enable Control
 * |        |          |for Center-aligned only
 * |        |          |0 = Interruptwhen EPWM Central Enabled.
 * |        |          |1 = Interruptwhen EPWM Central Enabled.
 * |[24]    |CMPDIEN0  |PWM Channel 0 DOWN Interrupt Enable Control
 * |        |          |DOWN for Edge-aligned and Center-aligned
 * |        |          |0 = Interruptcompare Disabled.
 * |        |          |1 = interruptwhen EPWM_CH0 PWM DOWN counter reaches EPWM_CMPDAT0 Enabled.
 * |[25]    |CMPDIEN1  |PWM Channel 1 DOWN Interrupt Enable Control
 * |        |          |DOWN for Edge-aligned and Center-aligned
 * |        |          |0 = Interruptcompare Disabled.
 * |        |          |1 = interruptwhen EPWM_CH1 PWM DOWN counter reaches EPWM_CMPDAT1 Enabled.
 * |[26]    |CMPDIEN2  |PWM Channel 2 DOWN Interrupt Enable Control
 * |        |          |DOWN for Edge-aligned and Center-aligned
 * |        |          |0 = Interruptcompare Disabled.
 * |        |          |1 = interruptwhen EPWM_CH2 PWM DOWN counter reaches EPWM_CMPDAT2 Enabled.
 * |[27]    |CMPDIEN3  |PWM Channel 3 DOWN Interrupt Enable Control
 * |        |          |DOWN for Edge-aligned and Center-aligned
 * |        |          |0 = Interruptcompare Disabled.
 * |        |          |1 = interruptwhen EPWM_CH3 PWM DOWN counter reaches EPWM_CMPDAT3 Enabled.
 * |[28]    |CMPDIEN4  |PWM Channel 4 DOWN Interrupt Enable Control
 * |        |          |DOWN for Edge-aligned and Center-aligned
 * |        |          |0 = Interruptcompare Disabled.
 * |        |          |1 = interruptwhen EPWM_CH4 PWM DOWN counter reaches EPWM_CMPDAT4 Enabled.
 * |[29]    |CMPDIEN5  |PWM Channel 5 DOWN Interrupt Enable Control
 * |        |          |DOWN for Edge-aligned and Center-aligned
 * |        |          |0 = Interruptcompare Disabled.
 * |        |          |1 = Interruptwhen EPWM_CH5 PWM DOWN counter reaches EPWM_CMPDAT5 Enabled.
 * @var EPWM_T::INTSTS
 ...
 * |        |          |Flag is set by hardware when PWM down counter reaches zero point
 * |        |          |Software can write 1 to clear this bit.
 * |[19]    |BRK0LOCK  |PWM Brake0 Locked
 * |        |          |0 = PWM Brake does not recognize a falling signal at BKP0.
 * |        |          |1 = When PWM Brake detects a falling signal at pin BKP0, this flag will be set to high, when this bit set high, it helps breaking PWM output even interrupt flag BRK0IF was cleared by CPU before jumping out from sub-routine.
 * |        |          |Note: Software can write 1 to clear this bit. 
 * |[20]    |BRKP0IF   |BRK Pin0 Status Flag.
 * |[21]    |BRKP1IF   |BRK Pin1 Status Flag
 * |[22]    |BRKP2IF   |BRK Pin2 Status Flag
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |BRK0EN    |Brake0 Function Enable Control
 * |        |          |0 = Brake0 detect function Disabled.
 * |        |          |1 = Brake0 detect function Enabled.
 * |[1]     |BRK1EN    |Brake1 Function Enable Control
 * |        |          |0 = Brake1 detect function Disabled.
 * |        |          |1 = Brake1 detect function Enabled.
 * |[2]     |BRK0A0EN  |BRK0 Source From ACMP0 Enable Control
 * |        |          |0 = BRK0 Source From ACMP0 Disabled.
 * |        |          |1 = BRK0 Source From ACMP0 Enabled.
 * |[4]     |BK0ADCEN  |BRK0 Source From ADC Enable Control
 * |        |          |0 = BRK0 Source From ADC Disabled.
 * |        |          |1 = BRK0 Source From ADC Enabled.
 * |[5]     |BRK0PEN   |BRK0 Source From External Pin Enable Control
 * |        |          |0 = BRK0 Source From External Pin Disabled.
 * |        |          |1 = BRK0 Source From External Pin Enabled.
 * |[6]     |BRKP0EN   |BRK Source From External Pin 0 Enable Control
 * |        |          |0 = BRK Source From External Pin0 Disabled.
 * |        |          |1 = BRK Source From External Pin0 Enabled.
 * |[7]     |BRKP1EN   |BRK Source From External Pin 1 Enable Control
 * |        |          |0 = BRK Source From External Pin1 Disabled.
 * |        |          |1 = BRK Source From External Pin1 Enabled.
 * |[8]     |BRKP2EN   |BRK Source From External Pin 2 Enable Control
 * |        |          |0 = BRK Source From External Pin2 Disabled.
 * |        |          |1 = BRK Source From External Pin2 Enabled.
 * |[9]     |SWBRK     |Software Break
 * |        |          |0 = Software break and back to normal PWM function Disabled.
 * |        |          |1 = Issue Software break Enabled.
 * |[10]    |BRK1A0EN  |BRK1 Source From ACMP0 Enable Control
 * |        |          |0 = BRK1 Source From ACMP0 Disabled.
 * |        |          |1 = BRK1 Source From ACMP0 Enabled.
 * |[12]    |BK1ADCEN  |BRK1 Source From ADC Enable Control
 * |        |          |0 = BRK1 Source From ADC Disabled.
 * |        |          |1 = BRK1 Source From ADC Enabled.
 * |[13]    |BRK1PEN   |BRK1 Source From External Pin Enable Control
 * |        |          |0 = BRK1 Source From External Pin Disabled.
 * |        |          |1 = BRK1 Source From External Pin Enabled.
 * |[14]    |LVDBKEN   |Low-level Detection Trigger PWM Brake Function 1 Enable Control
 ...
 * |[22:20] |NFCLKSEL  |Noise Filter Clock Pre-divide Selection
 * |        |          |To determine the sampling frequency of the Noise Filter clock .
 * |        |          |000 = EPWM_CLK.
 * |        |          |001 = EPWM _CLK/2.
 * |        |          |010 = EPWM _CLK/4.
 ...
 * |        |          |110 = EPWM _CLK/64
 * |        |          |111 = EPWM _CLK/128.
 * |[24]    |BKOD0     |PWM Channel 0 Brake Output Selection
 * |        |          |0 = PWM output low when fault brake conditions asserted.
 * |        |          |1 = PWM output high when fault brake conditions asserted.
 * |[25]    |BKOD1     |PWM Channel 1 Brake Output Selection
 * |        |          |0 = PWM output low when fault brake conditions asserted.
 * |        |          |1 = PWM output high when fault brake conditions asserted.
 * |[26]    |BKOD2     |PWM Channel 2 Brake Output Selection
 * |        |          |0 = PWM output low when fault brake conditions asserted.
 * |        |          |1 = PWM output high when fault brake conditions asserted.
 * |[27]    |BKOD3     |PWM Channel 3 Brake Output Selection
 * |        |          |0 = PWM output low when fault brake conditions asserted.
 * |        |          |1 = PWM output high when fault brake conditions asserted.
 * |[28]    |BKOD4     |PWM Channel 4 Brake Output Selection
 * |        |          |0 = PWM output low when fault brake conditions asserted.
 * |        |          |1 = PWM output high when fault brake conditions asserted.
 * |[29]    |BKOD5     |PWM Channel 5 Brake Output Selection
 * |        |          |0 = PWM output low when fault brake conditions asserted.
 * |        |          |1 = PWM output high when fault brake conditions asserted.
 * |[31]    |NFPEN     |Noise Filter for External Brake Input Pin (BRAKE) Enable Control
 * |        |          |0 = Noise Filter for External Brake Input Pin (BRAKE) Disabled.
 * |        |          |1 = Noise Filter for External Brake Input Pin (BRAKE) Enabled.
 * @var EPWM_T::DTCTL
 ...
 * |[6]     |BMSKDAT0  |Enable BPWM0 Mask Data
 * |        |          |0 = BPWM0 state is masked with zero.
 * |        |          |1 = BPWM0 state is masked with one.
 * |        |          |Note: This bit effects BPWM0 only when BPWM_CTL.BP0SYNEPWM is set.
 * |[7]     |BMSKDAT1  |Enable BPWM1 Mask Data
 * |        |          |0 = BPWM1 state is masked with zero.
 * |        |          |1 = BPWM1 state is masked with one.
 ...
 * |[14]    |BMSKEN0   |Enable BPWM0 Mask Function
 * |        |          |0 = BPWM0 Mask Function Disabled.
 * |        |          |1 = BPWM0 Mask Function Enabled.
 * |        |          |Note: This bit effects BPWM0 only when BPWM_CTL.BP0SYNEPWM is set.
 * |[15]    |BMSKEN1   |Enable BPWM1 Mask Function
 * |        |          |0 = BPWM1 Mask Function Disabled.
 * |        |          |1 = BPWM1 Mask Function Enabled.
 * |        |          |Note: This bit effects BPWM1 only when BPWM_CTL.BP1SYNEPWM is set.
 ...
 * |        |          |000 = Triggered by TMR0_MATCH event.
 * |        |          |001 = Triggered by TMR1_MATCH  event.
 * |        |          |010 = Triggered by CAPPHG_TRG from ECAP. (CAPTF0 | CAPTF1 | CAPTF2)
 * |        |          |011 = Triggered by HALLSTS (EPWM_PHCHGNXT[18:16]) matched (CAP2, CAP1, CAP0) in ECAP...
 * |        |          |100 = Triggered by ACMP0_PBRK event.
 * |        |          |101 = Reserved.
 * |        |          |110 = Triggered by TMR2_MATCH event..
 ...
 * |        |          |11 = Select ACMP0_P3 (PC.1) as the input of ACMP0.
 * |[28]    |ACMP0TEN  |ACMP0 Trigger Function Enable Control
 ...
 * |        |          |Refer to register PHCHG_NOW for detailed definition.
 * |[6]     |BMSKDAT0  |Enable BPWM0 Mask Data Preset Bit
 ...
 * |        |          |Note: This bit effects BPWM0 only when BPWM_CTL.BP0SYNEPWM is set
 * |[7]     |BMSKDAT1  |Enable BPWM1 Mask Data Preset Bit
 ...
 * |        |          |Refer to register PHCHG_NOW for detailed definition.
 * |[14]    |BMSKEN0   |Enable BPWM0 Mask Function Preset Bit
 * |        |          |This bit will be load to bit MSKEN4 in EPWM_PHCHG when load trigger condition occurs. 
 * |        |          |Refer to register EPWM_PHCHG for detailed definition.
 * |        |          |Note: This bit effects BPWM0 only when BPWM_CTL.BP0SYNEPWM is set
 * |[15]    |BMSKEN1   |Enable BPWM1 Mask Function Preset Bit
 ...
 */
    ...
    __IO uint32_t CMPDAT[6];             /*!< [0x0024] EPWM Comparator Register 0/1/2/3/4/5                             */
...
#define EPWM_CTL_DBGPWMOFF_Pos           (22)                                              /*!< EPWM_T::CTL: DBGPWMOFF Position        */
#define EPWM_CTL_DBGPWMOFF_Msk           (0x1ul << EPWM_CTL_DBGPWMOFF_Pos)                 /*!< EPWM_T::CTL: DBGPWMOFF Mask            */
...
#define EPWM_INTSTS_BRK0LOCK_Pos         (19)                                              /*!< EPWM_T::INTSTS: BRK0LOCK Position      */
#define EPWM_INTSTS_BRK0LOCK_Msk         (0x1ul << EPWM_INTSTS_BRK0LOCK_Pos)               /*!< EPWM_T::INTSTS: BRK0LOCK Mask          */

#define EPWM_INTSTS_BRKP0IF_Pos          (20)                                              /*!< EPWM_T::INTSTS: BRKP0IF Position       */
#define EPWM_INTSTS_BRKP0IF_Msk          (0x1ul << EPWM_INTSTS_BRKP0IF_Pos)                /*!< EPWM_T::INTSTS: BRKP0IF Mask           */

#define EPWM_INTSTS_BRKP1IF_Pos          (21)                                              /*!< EPWM_T::INTSTS: BRKP1IF Position       */
#define EPWM_INTSTS_BRKP1IF_Msk          (0x1ul << EPWM_INTSTS_BRKP1IF_Pos)                /*!< EPWM_T::INTSTS: BRKP1IF Mask           */

#define EPWM_INTSTS_BRKP2IF_Pos          (22)                                              /*!< EPWM_T::INTSTS: BRKP2IF Position       */
#define EPWM_INTSTS_BRKP2IF_Msk          (0x1ul << EPWM_INTSTS_BRKP2IF_Pos)                /*!< EPWM_T::INTSTS: BRKP2IF Mask           */
...
#define EPWM_BRKCTL_BRKP0EN_Pos          (6)                                               /*!< EPWM_T::BRKCTL: BRKP0EN Position       */
#define EPWM_BRKCTL_BRKP0EN_Msk          (0x1ul << EPWM_BRKCTL_BRKP0EN_Pos)                /*!< EPWM_T::BRKCTL: BRKP0EN Mask           */

#define EPWM_BRKCTL_BRKP1EN_Pos          (7)                                               /*!< EPWM_T::BRKCTL: BRKP1EN Position       */
#define EPWM_BRKCTL_BRKP1EN_Msk          (0x1ul << EPWM_BRKCTL_BRKP1EN_Pos)                /*!< EPWM_T::BRKCTL: BRKP1EN Mask           */

#define EPWM_BRKCTL_BRKP2EN_Pos          (8)                                               /*!< EPWM_T::BRKCTL: BRKP2EN Position       */
#define EPWM_BRKCTL_BRKP2EN_Msk          (0x1ul << EPWM_BRKCTL_BRKP2EN_Pos)                /*!< EPWM_T::BRKCTL: BRKP2EN Mask           */
...
#define EPWM_BRKCTL_NFCLKSEL_Pos         (20)                                              /*!< EPWM_T::BRKCTL: NFCLKSEL Position      */
#define EPWM_BRKCTL_NFCLKSEL_Msk         (0x7ul << EPWM_BRKCTL_NFCLKSEL_Pos)               /*!< EPWM_T::BRKCTL: NFCLKSEL Mask          */
...
#define EPWM_PHCHG_BMSKDAT0_Pos          (6)                                               /*!< EPWM_T::PHCHG: BMSKDAT0 Position       */
#define EPWM_PHCHG_BMSKDAT0_Msk          (0x1ul << EPWM_PHCHG_BMSKDAT0_Pos)                /*!< EPWM_T::PHCHG: BMSKDAT0 Mask           */

#define EPWM_PHCHG_BMSKDAT1_Pos          (7)                                               /*!< EPWM_T::PHCHG: BMSKDAT1 Position       */
#define EPWM_PHCHG_BMSKDAT1_Msk          (0x1ul << EPWM_PHCHG_BMSKDAT1_Pos)                /*!< EPWM_T::PHCHG: BMSKDAT1 Mask           */
...
#define EPWM_PHCHG_BMSKEN0_Pos           (14)                                              /*!< EPWM_T::PHCHG: BMSKEN0 Position        */
#define EPWM_PHCHG_BMSKEN0_Msk           (0x1ul << EPWM_PHCHG_BMSKEN0_Pos)                 /*!< EPWM_T::PHCHG: BMSKEN0 Mask            */

#define EPWM_PHCHG_BMSKEN1_Pos           (15)                                              /*!< EPWM_T::PHCHG: BMSKEN1 Position        */
#define EPWM_PHCHG_BMSKEN1_Msk           (0x1ul << EPWM_PHCHG_BMSKEN1_Pos)                 /*!< EPWM_T::PHCHG: BMSKEN1 Mask            */
...
#define EPWM_PHCHGNXT_BMSKDAT0_Pos       (6)                                               /*!< EPWM_T::PHCHGNXT: BMSKDAT0 Position    */
#define EPWM_PHCHGNXT_BMSKDAT0_Msk       (0x1ul << EPWM_PHCHGNXT_BMSKDAT0_Pos)             /*!< EPWM_T::PHCHGNXT: BMSKDAT0 Mask        */

#define EPWM_PHCHGNXT_BMSKDAT1_Pos       (7)                                               /*!< EPWM_T::PHCHGNXT: BMSKDAT1 Position    */
#define EPWM_PHCHGNXT_BMSKDAT1_Msk       (0x1ul << EPWM_PHCHGNXT_BMSKDAT1_Pos)             /*!< EPWM_T::PHCHGNXT: BMSKDAT1 Mask        */
...
#define EPWM_PHCHGNXT_BMSKEN0_Pos        (14)                                              /*!< EPWM_T::PHCHGNXT: BMSKEN0 Position     */
#define EPWM_PHCHGNXT_BMSKEN0_Msk        (0x1ul << EPWM_PHCHGNXT_BMSKEN0_Pos)              /*!< EPWM_T::PHCHGNXT: BMSKEN0 Mask         */

#define EPWM_PHCHGNXT_BMSKEN1_Pos        (15)                                              /*!< EPWM_T::PHCHGNXT: BMSKEN1 Position     */
#define EPWM_PHCHGNXT_BMSKEN1_Msk        (0x1ul << EPWM_PHCHGNXT_BMSKEN1_Pos)              /*!< EPWM_T::PHCHGNXT: BMSKEN1 Mask         */
 ...
 * |[16]    |BKODB0    |BPWM Channel 1 Brake Output Selection
 * |        |          |0 = BPWM0 output low when fault brake conditions asserted.
 * |        |          |1 = BPWM0 output high when fault brake conditions asserted.
 * |        |          |Note: This bit effects BPWM0 only when BP0SYNEPWM is set
 * |[17]    |BKODB1    |BPWM Channel 1 Brake Output Selection
 * |        |          |0 = BPWM1 output low when fault brake conditions asserted.
 * |        |          |1 = BPWM1 output high when fault brake conditions asserted.
 * |        |          |Note: This bit effects BPWM1 only when BP1SYNEPWM is set
 * |[24]    |BP0SYNEPWM|1 = When EPWM enable will also enable BPWM0 at the same time.
 * |[25]    |BP1SYNEPWM|1 = When EPWM enable will also enable BPWM1 at the same time.
 * |[30]    |CNTTYPE01 |PWM01 Aligned Type Selection
 * |        |          |0 = Edge-aligned type.
 * |        |          |1 = Center-aligned type.
 * @var BPWM_T::PERIOD0
...
#define BPWM_CTL_BKODB0_Pos              (16)                                              /*!< BPWM_T::CTL: BKODB0 Position           */
#define BPWM_CTL_BKODB0_Msk              (0x1ul << BPWM_CTL_BKODB0_Pos)                    /*!< BPWM_T::CTL: BKODB0 Mask               */

#define BPWM_CTL_BKODB1_Pos              (17)                                              /*!< BPWM_T::CTL: BKODB1 Position           */
#define BPWM_CTL_BKODB1_Msk              (0x1ul << BPWM_CTL_BKODB1_Pos)                    /*!< BPWM_T::CTL: BKODB1 Mask               */

#define BPWM_CTL_BP0SYNEPWM_Pos          (24)                                              /*!< BPWM_T::CTL: BP0SYNEPWM Position       */
#define BPWM_CTL_BP0SYNEPWM_Msk          (0x1ul << BPWM_CTL_BP0SYNEPWM_Pos)                /*!< BPWM_T::CTL: BP0SYNEPWM Mask           */

#define BPWM_CTL_BP1SYNEPWM_Pos          (25)                                              /*!< BPWM_T::CTL: BP1SYNEPWM Position       */
#define BPWM_CTL_BP1SYNEPWM_Msk          (0x1ul << BPWM_CTL_BP1SYNEPWM_Pos)                /*!< BPWM_T::CTL: BP1SYNEPWM Mask           */
 ...
 * |[3:2]   |ACMPHYSEN |Comparator0 Hysteresis Enable Control
 * |        |          |00 = ACMP0 Hysteresis function Disabled (Default).
 * |        |          |01 = ACMP0 Hysteresis function at comparator 0 Enabled that the typical range is 10mV.
 * |        |          |10 = ACMP0 Hysteresis function at comparator 0 Enabled that the typical range is 90mV.
 * |        |          |11 = ACMP0 Hysteresis function at comparator 0 Enabled that the typical range is 150mV.
 * |[5:4]   |EDGESEL   |Interrupt Flag Trigger Edge Detection
 * |        |          |00 = Interrupt Flag Trigger Edge Disabled.
 * |        |          |01 = Rising.
 * |        |          |10 = Falling.
 * |        |          |11 = Rising/Falling.
 ...
 * |        |          |00 = Analog Comparator Delay Trigger Mode Trigger Disabled.
 * |        |          |01 = Rising.
 * |        |          |10 = Falling.
 * |        |          |11 = Rising/Falling.
 ...
 * |        |          |10 = EPWM_CH4.
 * |        |          |11 = TMR2_MATCH.
 * |[12]    |DLYTRGEN  |Analog Comparator Delay Trigger Mode Enable Control
 * |        |          |0 = Analog Comparator Delay Trigger Mode Disabled.
 * |        |          |1 = Analog Comparator Delay Trigger Mode Enabled.
 * |[13]    |DLYTRGIE  |Analog Comparator Delay Trigger Mode Interrupt Enable Control
 * |        |          |0 = Analog Comparator Delay Trigger Mode Interrupt Disabled.
 * |        |          |1 = Analog Comparator Delay Trigger Mode Interrupt Enabled.
 * |[15:14] |DLYEDGESEL|PWM Interrupt Flag Trigger Edge Detection
 * |        |          |00 = Interrupt Flag Trigger Edge Disabled.
 * |        |          |01 = Rising.
 * |        |          |10 = Falling.
 * |        |          |11 = Rising/Falling.
 ...
 * |        |          |0 = Noise filter Enabled.
 * |        |          |1 = Noise filter Disabled.
 ...
 * @var ACMP_T::DACVAL
 * Offset: 0x14  DAC Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |DAC0      |DAC0 Referance Voltage (VDD x DAC0[11:0]/4096)
 * |        |          |ACMP_CTL0[25:24] (CPNSEL)=2’b11, DAC0 use as ACMP0 negative Input.
 * |        |          |When SYS_GPB_MFP[23:20]=4, DAC0 can output referance voltahe from PB.5
 * |[27:16] |DAC1      |DAC1 Referance Voltage (VDD x DAC1[11:0]/4096)
 * |        |          |ACMP_CTL1[25:24] (CPNSEL)=2’b11, DAC1 use as ACMP1 CN negative Input.
 * |        |          |When SYS_GPC_MFP[27:24]=5, DAC1 can output referance voltahe from PC.6
 * @var ACMP_T::DACCTL
 * Offset: 0x18  DAC Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |DAC0BUFEN |DAC0 Output Amplifier Enable Control
 * |        |          |0 = Amplifier Disabled.
 * |        |          |1 = Amplifier Enabled.
 * |[1]     |DAC1BUFEN |DAC1 Output Amplifier Enable Control
 * |        |          |0 = Amplifier Disabled.
 * |        |          |1 = Amplifier Enabled.

 */
    __IO uint32_t CTL[1];                /*!< [0x0000] Analog Comparator0 Control Register                              */
    ...
    __IO uint32_t DACVAL;                /*!< [0x0014] DAC Register                                                     */
    __IO uint32_t DACCTL;                /*!< [0x0018] DAC Buffer Control Register                                      */
...
#define ACMP_CTL_DLYEDGESEL_Pos          (14)                                              /*!< ACMP_T::CTL: DLYTRGIE Position         */
#define ACMP_CTL_DLYEDGESEL_Msk          (0x3ul << ACMP_CTL_DLYEDGESEL_Pos)                  /*!< ACMP_T::CTL: DLYTRGIE Mask             */
...
#define ACMP_CTL_NFCLKS_Msk              (0x7ul << ACMP_CTL_NFCLKS_Pos)                    /*!< ACMP_T::CTL: NFCLKS Mask               */
...
#define ACMP_DACVAL_DAC0_Pos             (0)                                               /*!< ACMP_T::DACVAL: DAC0 Position          */
#define ACMP_DACVAL_DAC0_Msk             (0xffful << ACMP_DACVAL_DAC0_Pos)                 /*!< ACMP_T::DACVAL: DAC0 Mask              */

#define ACMP_DACVAL_DAC1_Pos             (16)                                              /*!< ACMP_T::DACVAL: DAC1 Position          */
#define ACMP_DACVAL_DAC1_Msk             (0xffful << ACMP_DACVAL_DAC1_Pos)                 /*!< ACMP_T::DACVAL: DAC1 Mask              */

#define ACMP_DACCTL_DAC0BUFEN_Pos        (0)                                               /*!< ACMP_T::DACCTL: DAC0BUFEN Position     */
#define ACMP_DACCTL_DAC0BUFEN_Msk        (0x1ul << ACMP_DACCTL_DAC0BUFEN_Pos)              /*!< ACMP_T::DACCTL: DAC0BUFEN Mask         */

#define ACMP_DACCTL_DAC1BUFEN_Pos        (1)                                               /*!< ACMP_T::DACCTL: DAC1BUFEN Position     */
#define ACMP_DACCTL_DAC1BUFEN_Msk        (0x1ul << ACMP_DACCTL_DAC1BUFEN_Pos)              /*!< ACMP_T::DACCTL: DAC1BUFEN Mask         */
...
/**
    @addtogroup ADC Enhanced Analog to Digital Converter(ADC)
...
/**
 * @var ADC_T::CS_CTL
 * Offset: 0x10  ADC Channel Select Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |ADC0CSEN  |ADC0(SH0) Channel Select Enable
 * |        |          |Bit0 = 1, use to enable ADC0_CH0. (PB.0).
 * |        |          |Bit1 = 1, use to enable ADC0_CH1. (PB.1).
 * |        |          |Bit2 = 1, use to enable ADC0_CH2. (PB.2).
 * |        |          |Bit3 = 1, use to enable ADC0_CH3. (PC.0).
 * |        |          |Bit4 = 1, use to enable ADC0_CH4. (PC.1).
 * |        |          |Bit5 = 1, use to enable ADC0_CH8. (PF.2)
 * |        |          |Bit6 = 1, use to enable BAND_GAP. (BG 1.2V)
 * |        |          |Bit7 = 1, use to enable VSS.
 * |        |          |Bit8 = 1, use to enable ADC0_CH9. (PB.3).
 * |        |          |Bit9 = 1, use to enable OP1. (PE.2).
 * |        |          |Bit10 = 1, use to enable ADC1_CH0. (PB.4).
 * |        |          |Bit11 = 1, use to enable DAC0.
 * |        |          |Bit12 = 1, use to enable DAC1.
 * |        |          |Bit13 = 1, use to enable ADC0_CH5. (PB.5).
 * |        |          |Bit14 = 1, use to enable ADC0_CH6. (PB.6).
 * |        |          |Bit15 = 1, use to enable ADC0_CH7. (PB.7).
 * |[31:16] |ADC1CSEN  |ADC1(SH1) Channel Select Enable
 * |        |          |Bit0 = 1, use to enable ADC1_CH0. (PB.4)
 * |        |          |Bit1 = 1, use to enable ADC1_CH1. (PD.2)
 * |        |          |Bit2 = 1, use to enable ADC1_CH2. (PC.2)
 * |        |          |Bit3 = 1, use to enable ADC0_CH0. (PB.0)
 * |        |          |Bit4 = 1, use to enable ADC0_CH4. (PC.1)
 * |        |          |Bit5 = 1, use to enable ADC1_CH8. (PE.3)
 * |        |          |Bit6 = 1, use to enable Temp Sensor.
 * |        |          |Bit7 = 1, use to enable VSS.
 * |        |          |Bit8 = 1, use to enable ADC1_CH9. (PE.4)
 * |        |          |Bit9 = 1, use to enable OP1. (PE.2)
 * |        |          |Bit10 = 1, use to enable DAC0
 * |        |          |Bit11 = 1, use to enable ADC1_CH3. (PF.3)
 * |        |          |Bit12 = 1, use to enable ADC1_CH4. (PF.4)
 * |        |          |Bit13 = 1, use to enable ADC1_CH5. (PC.5)
 * |        |          |Bit14 = 1, use to enable ADC1_CH6. (PC.6)
 * |        |          |Bit15 = 1, use to enable ADC1_CH7. (PC.7)
 * @var ADC_T::CTL
 * Offset: 0x20  ADC Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |ADCEN     |ADC Converter Enable
 * |        |          |0 = ADC Converter Disabled.
 * |        |          |1 = ADC Converter Enabled.
 * |        |          |Note: Before starting the A/D conversion function, this bit should be set to "1"
 ...
 * |        |          |Note: A/D conversion end interrupt request is generated if ADC0IEN bit is set to "1".
 ...
 * |        |          |1 = Conversion start.
 * |        |          |Note: ADC0SWTRG can be set to "1" from two sources: software and external pin STADC
 * |        |          |This bit will be cleared to "0" by hardware automatically.
 * |[7:6]   |ADCMODE   |A/D Conversion Mode
 ...
 * |[9]     |ADC1IEN   |ADC1 Interrupt Enable Control
 * |        |          |0 = ADC1 interrupt function Disabled.
 * |        |          |1 = ADC1 interrupt function Enabled.
 * |        |          |Note: A/D conversion end interrupt request is generated if ADC1IEN bit is set to "1".
 * |[10]    |ADC1HWTRGEN|Hardware Trigger ADC Convertion Enable Control
 * |        |          |Enable or disable triggering of A/D conversion by Hardware (PWM, Timer, ADC self)
 ...
 * |        |          |0 = Conversion stopped and A/D converter entered idle state.
 * |        |          |1 = Conversion start.
 * |        |          |Note: ADC1SWTRG can be set to "1" from two sources: software and external pin STADC
 * |        |          |This bit will be cleared to "0" by hardware automatically.
 * @var ADC_T::TRGSOR
 * Offset: 0x24  ADC Hardware Trigger Source Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |11 = Reserved.
 * @var ADC_T::TRGDLY
 * Offset: 0x28  ADC Trigger Delay Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var ADC_T::SMPCNT
 * Offset: 0x2C  ADC Sampling Time Counter Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |For normal channel:
 * |        |          |Sampling time = PCLK X ( ADCSMPCNT X 4 ) + 2
 * |        |          |For VBG or Temperature channel:
 * |        |          |Sampling time = PCLK X ( ADCSMPCNT X 64 ) + 2
 * |        |          |Note: Recommend sampling time is over 400ns.
 * |        |          |For example, ADCSMPCNT=5  The sampling time is 458ns.
 * @var ADC_T::STATUS
 ...
 * |        |          |It is read only.
 * |[23]    |ADC0EOC   |ADC0 end of convert.
 * |[31]    |ADC1EOC   |ADC1 end of convert.
 * @var ADC_T::VALSTS
 * Offset: 0x40  ADC Valid Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |ADC0VALID |Bits set 1 when ADC0 CHn convertion is finished, and it is automatically cleared when ADC0_DATn is read.
 * |[31:16] |ADC1VALID |Bits set 1 when ADC1 CHn convertion is finished, and it is automatically cleared when ADC1_DATn is read.
 * @var ADC_T::ADC0_DATn
 * Offset: 0x80+4n ; n=0, 1,..15   ADC0 Data Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |ADC0DATn  |ADC0 Conversion Result
 * |        |          |This field contains conversion result of ADC.
 * @var ADC_T::ADC1_DATn
 * Offset: 0xC0+4n ; n=0, 1,..15   ADC1 Data Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[11:0]  |ADC1DATn  |ADC1 Conversion Result
 * |        |          |This field contains conversion result of ADC. 
 */
	__I  uint32_t RESERVE0[4];
	__IO uint32_t CS_CTL;             	 /*!< [0x0010] ADC Switch Control Register                                     */
	__I  uint32_t RESERVE1[3];
  ...
  __IO uint32_t VALSTS;                /*!< [0x0030] ADC Valid Status Register                                       */
	__I  uint32_t RESERVE3[15];
	__I	 uint32_t ADC0_DAT0;			   	   /*!< [0x0080] ADC0 Data Register 0                                            */
	__I	 uint32_t ADC0_DAT1;	           /*!< [0x0084] ADC0 Data Register 1                                            */
	__I	 uint32_t ADC0_DAT2;	           /*!< [0x0088] ADC0 Data Register 2                                            */
	__I	 uint32_t ADC0_DAT3;	           /*!< [0x008C] ADC0 Data Register 3                                            */
	__I	 uint32_t ADC0_DAT4;	           /*!< [0x0090] ADC0 Data Register 4                                            */
	__I	 uint32_t ADC0_DAT5;	           /*!< [0x0094] ADC0 Data Register 5                                            */
	__I	 uint32_t ADC0_DAT6;	           /*!< [0x0098] ADC0 Data Register 6                                            */
	__I	 uint32_t ADC0_DAT7;	           /*!< [0x009C] ADC0 Data Register 7                                            */
	__I	 uint32_t ADC0_DAT8;	           /*!< [0x00A0] ADC0 Data Register 8                                            */
	__I	 uint32_t ADC0_DAT9;	           /*!< [0x00A4] ADC0 Data Register 9                                            */
	__I	 uint32_t ADC0_DAT10;	           /*!< [0x00A8] ADC0 Data Register 10                                           */
	__I	 uint32_t ADC0_DAT11;	           /*!< [0x00AC] ADC0 Data Register 11                                           */
	__I	 uint32_t ADC0_DAT12;	           /*!< [0x00B0] ADC0 Data Register 12                                           */
	__I	 uint32_t ADC0_DAT13;	           /*!< [0x00B4] ADC0 Data Register 13                                           */
	__I	 uint32_t ADC0_DAT14;	           /*!< [0x00B8] ADC0 Data Register 14                                           */
	__I	 uint32_t ADC0_DAT15;	           /*!< [0x00BC] ADC0 Data Register 15                                           */
	__I	 uint32_t ADC1_DAT0;	           /*!< [0x00C0] ADC1 Data Register 0                                            */
	__I	 uint32_t ADC1_DAT1;             /*!< [0x00C4] ADC1 Data Register 1                                            */
	__I	 uint32_t ADC1_DAT2;	           /*!< [0x00C8] ADC1 Data Register 2                                            */
	__I	 uint32_t ADC1_DAT3;	           /*!< [0x00CC] ADC1 Data Register 3                                            */
	__I	 uint32_t ADC1_DAT4;	           /*!< [0x00D0] ADC1 Data Register 4                                            */
	__I	 uint32_t ADC1_DAT5;	           /*!< [0x00D4] ADC1 Data Register 5                                            */
	__I	 uint32_t ADC1_DAT6;	           /*!< [0x00D8] ADC1 Data Register 6                                            */
	__I	 uint32_t ADC1_DAT7;	           /*!< [0x00DC] ADC1 Data Register 7                                            */
	__I	 uint32_t ADC1_DAT8;	           /*!< [0x00E0] ADC1 Data Register 8                                            */
	__I	 uint32_t ADC1_DAT9;	           /*!< [0x00E4] ADC1 Data Register 9                                            */
	__I	 uint32_t ADC1_DAT10;	           /*!< [0x00E8] ADC1 Data Register 10                                           */
	__I	 uint32_t ADC1_DAT11;	           /*!< [0x00EC] ADC1 Data Register 11                                           */
	__I	 uint32_t ADC1_DAT12;	           /*!< [0x00F0] ADC1 Data Register 12                                           */
	__I	 uint32_t ADC1_DAT13;	           /*!< [0x00F4] ADC1 Data Register 13                                           */
	__I	 uint32_t ADC1_DAT14;	           /*!< [0x00F8] ADC1 Data Register 14                                           */
	__I	 uint32_t ADC1_DAT15;	           /*!< [0x00FC] ADC1 Data Register 15                                           */
...
#define ADC_CS_CTL_ADC0CSEN_Pos          (0)                                               /*!< ADC_T::CS_CTL: ADC0CSEN Position       */
#define ADC_CS_CTL_ADC0CSEN_Msk          (0xfffful << ADC_CS_CTL_ADC0CSEN_Pos)             /*!< ADC_T::CS_CTL: ADC0CSEN Mask           */

#define ADC_CS_CTL_ADC1CSEN_Pos          (16)                                              /*!< ADC_T::CS_CTL: ADC1CSEN Position       */
#define ADC_CS_CTL_ADC1CSEN_Msk          (0xfffful << ADC_CS_CTL_ADC1CSEN_Pos)             /*!< ADC_T::CS_CTL: ADC1CSEN Mask           */

#define ADC_CTL_ADCEN_Pos                (0)                                               /*!< ADC_T::CTL: ADCEN Position             */
#define ADC_CTL_ADCEN_Msk                (0x1ul << ADC_CTL_ADCEN_Pos)                      /*!< ADC_T::CTL: ADCEN Mask                 */

#define ADC_CTL_ADC0IEN_Pos              (1)                                               /*!< ADC_T::CTL: ADC0IEN Position           */
#define ADC_CTL_ADC0IEN_Msk              (0x1ul << ADC_CTL_ADC0IEN_Pos)                    /*!< ADC_T::CTL: ADC0IEN Mask               */

#define ADC_CTL_ADC0HWTRGEN_Pos          (2)                                               /*!< ADC_T::CTL: ADC0HWTRGEN Position       */
#define ADC_CTL_ADC0HWTRGEN_Msk          (0x1ul << ADC_CTL_ADC0HWTRGEN_Pos)                /*!< ADC_T::CTL: ADC0HWTRGEN Mask           */

#define ADC_CTL_ADC0SWTRG_Pos            (3)                                               /*!< ADC_T::CTL: ADC0SWTRG Position         */
#define ADC_CTL_ADC0SWTRG_Msk            (0x1ul << ADC_CTL_ADC0SWTRG_Pos)                  /*!< ADC_T::CTL: ADC0SWTRG Mask             */

#define ADC_CTL_ADCMODE_Pos              (6)                                               /*!< ADC_T::CTL: ADCMODE Position           */
#define ADC_CTL_ADCMODE_Msk              (0x3ul << ADC_CTL_ADCMODE_Pos)                    /*!< ADC_T::CTL: ADCMODE Mask               */

#define ADC_CTL_ADC1IEN_Pos              (9)                                               /*!< ADC_T::CTL: ADC1IEN Position           */
#define ADC_CTL_ADC1IEN_Msk              (0x1ul << ADC_CTL_ADC1IEN_Pos)                    /*!< ADC_T::CTL: ADC1IEN Mask               */

#define ADC_CTL_ADC1HWTRGEN_Pos          (10)                                              /*!< ADC_T::CTL: ADC1HWTRGEN Position       */
#define ADC_CTL_ADC1HWTRGEN_Msk          (0x1ul << ADC_CTL_ADC1HWTRGEN_Pos)                /*!< ADC_T::CTL: ADC1HWTRGEN Mask           */

#define ADC_CTL_ADC1SWTRG_Pos            (11)                                              /*!< ADC_T::CTL: ADC1SWTRG Position         */
#define ADC_CTL_ADC1SWTRG_Msk            (0x1ul << ADC_CTL_ADC1SWTRG_Pos)                  /*!< ADC_T::CTL: ADC1SWTRG Mask             */

#define ADC_TRGSOR_ADC0TRGSOR_Pos        (0)                                               /*!< ADC_T::TRGSOR: ADC0TRGSOR Position     */
#define ADC_TRGSOR_ADC0TRGSOR_Msk        (0xful << ADC_TRGSOR_ADC0TRGSOR_Pos)              /*!< ADC_T::TRGSOR: ADC0TRGSOR Mask         */

#define ADC_TRGSOR_ADC0PWMTRGSEL_Pos     (4)                                               /*!< ADC_T::TRGSOR: ADC0PWMTRGSEL Position  */
#define ADC_TRGSOR_ADC0PWMTRGSEL_Msk     (0x3ul << ADC_TRGSOR_ADC0PWMTRGSEL_Pos)           /*!< ADC_T::TRGSOR: ADC0PWMTRGSEL Mask      */

#define ADC_TRGSOR_ADC0STADCSEL_Pos      (6)                                               /*!< ADC_T::TRGSOR: ADC0STADCSEL Position   */
#define ADC_TRGSOR_ADC0STADCSEL_Msk      (0x3ul << ADC_TRGSOR_ADC0STADCSEL_Pos)            /*!< ADC_T::TRGSOR: ADC0STADCSEL Mask       */

#define ADC_TRGSOR_ADC1TRGSOR_Pos        (16)                                              /*!< ADC_T::TRGSOR: ADC1TRGSOR Position     */
#define ADC_TRGSOR_ADC1TRGSOR_Msk        (0xful << ADC_TRGSOR_ADC1TRGSOR_Pos)              /*!< ADC_T::TRGSOR: ADC1TRGSOR Mask         */

#define ADC_TRGSOR_ADC1PWMTRGSEL_Pos     (20)                                              /*!< ADC_T::TRGSOR: ADC1PWMTRGSEL Position  */
#define ADC_TRGSOR_ADC1PWMTRGSEL_Msk     (0x3ul << ADC_TRGSOR_ADC1PWMTRGSEL_Pos)           /*!< ADC_T::TRGSOR: ADC1PWMTRGSEL Mask      */

#define ADC_TRGSOR_ADC1STADCSEL_Pos      (22)                                              /*!< ADC_T::TRGSOR: ADC1STADCSEL Position   */
#define ADC_TRGSOR_ADC1STADCSEL_Msk      (0x3ul << ADC_TRGSOR_ADC1STADCSEL_Pos)            /*!< ADC_T::TRGSOR: ADC1STADCSEL Mask       */

#define ADC_TRGSOR_SADC1TRGSOR_Pos       (24)                                              /*!< ADC_T::TRGSOR: SADC1TRGSOR Position    */
#define ADC_TRGSOR_SADC1TRGSOR_Msk       (0xful << ADC_TRGSOR_SADC1TRGSOR_Pos)             /*!< ADC_T::TRGSOR: SADC1TRGSOR Mask        */

#define ADC_TRGDLY_ADC0DELAY_Pos         (0)                                               /*!< ADC_T::TRGDLY: ADC0DELAY Position      */
#define ADC_TRGDLY_ADC0DELAY_Msk         (0xfful << ADC_TRGDLY_ADC0DELAY_Pos)              /*!< ADC_T::TRGDLY: ADC0DELAY Mask          */

#define ADC_TRGDLY_ADC1DELAY_Pos         (16)                                              /*!< ADC_T::TRGDLY: ADC1DELAY Position      */
#define ADC_TRGDLY_ADC1DELAY_Msk         (0xfful << ADC_TRGDLY_ADC1DELAY_Pos)              /*!< ADC_T::TRGDLY: ADC1DELAY Mask          */

#define ADC_SMPCNT_ADCSMPCNT_Pos         (0)                                               /*!< ADC_T::SMPCNT: ADCSMPCNT Position      */
#define ADC_SMPCNT_ADCSMPCNT_Msk         (0xful << ADC_SMPCNT_ADCSMPCNT_Pos)               /*!< ADC_T::SMPCNT: ADCSMPCNT Mask          */

#define ADC_STATUS_ADC0IF_Pos            (0)                                               /*!< ADC_T::STATUS: ADC0IF Position         */
#define ADC_STATUS_ADC0IF_Msk            (0x1ul << ADC_STATUS_ADC0IF_Pos)                  /*!< ADC_T::STATUS: ADC0IF Mask             */

#define ADC_STATUS_ADC0BUSY_Pos          (3)                                               /*!< ADC_T::STATUS: ADC0BUSY Position       */
#define ADC_STATUS_ADC0BUSY_Msk          (0x1ul << ADC_STATUS_ADC0BUSY_Pos)                /*!< ADC_T::STATUS: ADC0BUSY Mask           */

#define ADC_STATUS_ADC0CH_Pos            (4)                                               /*!< ADC_T::STATUS: ADC0CH Position         */
#define ADC_STATUS_ADC0CH_Msk            (0xful << ADC_STATUS_ADC0CH_Pos)                  /*!< ADC_T::STATUS: ADC0CH Mask             */

#define ADC_STATUS_ADC1IF_Pos            (8)                                               /*!< ADC_T::STATUS: ADC1IF Position         */
#define ADC_STATUS_ADC1IF_Msk            (0x1ul << ADC_STATUS_ADC1IF_Pos)                  /*!< ADC_T::STATUS: ADC1IF Mask             */

#define ADC_STATUS_ADC1BUSY_Pos          (11)                                              /*!< ADC_T::STATUS: ADC1BUSY Position       */
#define ADC_STATUS_ADC1BUSY_Msk          (0x1ul << ADC_STATUS_ADC1BUSY_Pos)                /*!< ADC_T::STATUS: ADC1BUSY Mask           */

#define ADC_STATUS_ADC1CH_Pos            (12)                                              /*!< ADC_T::STATUS: ADC1CH Position         */
#define ADC_STATUS_ADC1CH_Msk            (0xful << ADC_STATUS_ADC1CH_Pos)                  /*!< ADC_T::STATUS: ADC1CH Mask             */

#define ADC_STATUS_ADC0EOC_Pos           (23)                                              /*!< ADC_T::STATUS: ADC0EOC Position         */
#define ADC_STATUS_ADC0EOC_Msk           (0x1ul << ADC_STATUS_ADC0EOC_Pos)                 /*!< ADC_T::STATUS: ADC0EOC Mask             */

#define ADC_STATUS_ADC1EOC_Pos           (31)                                              /*!< ADC_T::STATUS: ADC1EOC Position          */
#define ADC_STATUS_ADC1EOC_Msk           (0x1ul << ADC_STATUS_ADC1EOC_Pos)                 /*!< ADC_T::STATUS: ADC1EOC Mask              */

#define ADC_VALSTS_ADC0VALID_Pos         (0)                                               /*!< ADC_T::VALSTS: ADC0VALID Position        */
#define ADC_VALSTS_ADC0VALID_Msk         (0xfffful << ADC_VALSTS_ADC0VALID_Pos)            /*!< ADC_T::VALSTS: ADC0VALID Mask            */

#define ADC_VALSTS_ADC1VALID_Pos         (16)                                              /*!< ADC_T::VALSTS: ADC1VALID Position        */
#define ADC_VALSTS_ADC1VALID_Msk         (0xfffful << ADC_VALSTS_ADC1VALID_Pos)            /*!< ADC_T::VALSTS: ADC1VALID Mask            */

#define ADC_ADC0DAT0_ADC0DAT0_Pos        (0)                                               /*!< ADC_T::ADC0DAT0: ADC0DAT0 Position         */
#define ADC_ADC0DAT0_ADC0DAT0_Msk        (0xffful << ADC_ADC0DAT0_ADC0DAT0_Pos)            /*!< ADC_T::ADC0DAT0: ADC0DAT0 Mask             */

#define ADC_ADC0DAT1_ADC0DAT1_Pos        (0)                                               /*!< ADC_T::ADC0DAT1: ADC0DAT1 Position         */
#define ADC_ADC0DAT1_ADC0DAT1_Msk        (0xffful << ADC_ADC0DAT1_ADC0DAT1_Pos)            /*!< ADC_T::ADC0DAT1: ADC0DAT1 Mask             */

#define ADC_ADC0DAT2_ADC0DAT2_Pos        (0)                                               /*!< ADC_T::ADC0DAT2: ADC0DAT2 Position         */
#define ADC_ADC0DAT2_ADC0DAT2_Msk        (0xffful << ADC_ADC0DAT2_ADC0DAT2_Pos)            /*!< ADC_T::ADC0DAT2: ADC0DAT2 Mask             */

#define ADC_ADC0DAT3_ADC0DAT3_Pos        (0)                                               /*!< ADC_T::ADC0DAT3: ADC0DAT3 Position         */
#define ADC_ADC0DAT3_ADC0DAT3_Msk        (0xffful << ADC_ADC0DAT3_ADC0DAT3_Pos)            /*!< ADC_T::ADC0DAT3: ADC0DAT3 Mask             */

#define ADC_ADC0DAT4_ADC0DAT4_Pos        (0)                                               /*!< ADC_T::ADC0DAT4: ADC0DAT4 Position         */
#define ADC_ADC0DAT4_ADC0DAT4_Msk        (0xffful << ADC_ADC0DAT4_ADC0DAT4_Pos)            /*!< ADC_T::ADC0DAT4: ADC0DAT4 Mask             */

#define ADC_ADC0DAT5_ADC0DAT5_Pos        (0)                                               /*!< ADC_T::ADC0DAT5: ADC0DAT5 Position         */
#define ADC_ADC0DAT5_ADC0DAT5_Msk        (0xffful << ADC_ADC0DAT5_ADC0DAT5_Pos)            /*!< ADC_T::ADC0DAT5: ADC0DAT5 Mask             */

#define ADC_ADC0DAT6_ADC0DAT6_Pos        (0)                                               /*!< ADC_T::ADC0DAT6: ADC0DAT6 Position         */
#define ADC_ADC0DAT6_ADC0DAT6_Msk        (0xffful << ADC_ADC0DAT6_ADC0DAT6_Pos)            /*!< ADC_T::ADC0DAT6: ADC0DAT6 Mask             */

#define ADC_ADC0DAT7_ADC0DAT7_Pos        (0)                                               /*!< ADC_T::ADC0DAT7: ADC0DAT7 Position         */
#define ADC_ADC0DAT7_ADC0DAT7_Msk        (0xffful << ADC_ADC0DAT7_ADC0DAT7_Pos)            /*!< ADC_T::ADC0DAT7: ADC0DAT7 Mask             */

#define ADC_ADC0DAT8_ADC0DAT8_Pos        (0)                                               /*!< ADC_T::ADC0DAT8: ADC0DAT8 Position         */
#define ADC_ADC0DAT8_ADC0DAT8_Msk        (0xffful << ADC_ADC0DAT8_ADC0DAT8_Pos)            /*!< ADC_T::ADC0DAT8: ADC0DAT8 Mask             */

#define ADC_ADC0DAT9_ADC0DAT9_Pos        (0)                                               /*!< ADC_T::ADC0DAT9: ADC0DAT9 Position         */
#define ADC_ADC0DAT9_ADC0DAT9_Msk        (0xffful << ADC_ADC0DAT9_ADC0DAT9_Pos)            /*!< ADC_T::ADC0DAT9: ADC0DAT9 Mask             */

#define ADC_ADC0DAT10_ADC0DAT10_Pos      (0)                                               /*!< ADC_T::ADC0DAT10: ADC0DAT10 Position         */
#define ADC_ADC0DAT10_ADC0DAT10_Msk      (0xffful << ADC_ADC0DAT10_ADC0DAT10_Pos)          /*!< ADC_T::ADC0DAT10: ADC0DAT10 Mask             */

#define ADC_ADC0DAT11_ADC0DAT11_Pos      (0)                                               /*!< ADC_T::ADC0DAT11: ADC0DAT11 Position         */
#define ADC_ADC0DAT11_ADC0DAT11_Msk      (0xffful << ADC_ADC0DAT11_ADC0DAT11_Pos)          /*!< ADC_T::ADC0DAT11: ADC0DAT11 Mask             */

#define ADC_ADC0DAT12_ADC0DAT12_Pos      (0)                                               /*!< ADC_T::ADC0DAT12: ADC0DAT12 Position         */
#define ADC_ADC0DAT12_ADC0DAT12_Msk      (0xffful << ADC_ADC0DAT12_ADC0DAT12_Pos)          /*!< ADC_T::ADC0DAT12: ADC0DAT12 Mask             */

#define ADC_ADC0DAT13_ADC0DAT13_Pos      (0)                                               /*!< ADC_T::ADC0DAT13: ADC0DAT13 Position         */
#define ADC_ADC0DAT13_ADC0DAT13_Msk      (0xffful << ADC_ADC0DAT13_ADC0DAT13_Pos)          /*!< ADC_T::ADC0DAT13: ADC0DAT13 Mask             */

#define ADC_ADC0DAT14_ADC0DAT14_Pos      (0)                                               /*!< ADC_T::ADC0DAT14: ADC0DAT14 Position         */
#define ADC_ADC0DAT14_ADC0DAT14_Msk      (0xffful << ADC_ADC0DAT14_ADC0DAT14_Pos)          /*!< ADC_T::ADC0DAT14: ADC0DAT14 Mask             */

#define ADC_ADC0DAT15_ADC0DAT15_Pos      (0)                                               /*!< ADC_T::ADC0DAT15: ADC0DAT15 Position         */
#define ADC_ADC0DAT15_ADC0DAT15_Msk      (0xffful << ADC_ADC0DAT15_ADC0DAT15_Pos)          /*!< ADC_T::ADC0DAT15: ADC0DAT15 Mask             */

#define ADC_ADC1DAT0_ADC1DAT0_Pos        (0)                                               /*!< ADC_T::ADC1DAT0: ADC1DAT0 Position         */
#define ADC_ADC1DAT0_ADC1DAT0_Msk        (0xffful << ADC_ADC1DAT0_ADC1DAT0_Pos)            /*!< ADC_T::ADC1DAT0: ADC1DAT0 Mask             */

#define ADC_ADC1DAT1_ADC1DAT1_Pos        (0)                                               /*!< ADC_T::ADC1DAT1: ADC1DAT1 Position         */
#define ADC_ADC1DAT1_ADC1DAT1_Msk        (0xffful << ADC_ADC1DAT1_ADC1DAT1_Pos)            /*!< ADC_T::ADC1DAT1: ADC1DAT1 Mask             */

#define ADC_ADC1DAT2_ADC1DAT2_Pos        (0)                                               /*!< ADC_T::ADC1DAT2: ADC1DAT2 Position         */
#define ADC_ADC1DAT2_ADC1DAT2_Msk        (0xffful << ADC_ADC1DAT2_ADC1DAT2_Pos)            /*!< ADC_T::ADC1DAT2: ADC1DAT2 Mask             */

#define ADC_ADC1DAT3_ADC1DAT3_Pos        (0)                                               /*!< ADC_T::ADC1DAT3: ADC1DAT3 Position         */
#define ADC_ADC1DAT3_ADC1DAT3_Msk        (0xffful << ADC_ADC1DAT3_ADC1DAT3_Pos)            /*!< ADC_T::ADC1DAT3: ADC1DAT3 Mask             */

#define ADC_ADC1DAT4_ADC1DAT4_Pos        (0)                                               /*!< ADC_T::ADC1DAT4: ADC1DAT4 Position         */
#define ADC_ADC1DAT4_ADC1DAT4_Msk        (0xffful << ADC_ADC1DAT4_ADC1DAT4_Pos)            /*!< ADC_T::ADC1DAT4: ADC1DAT4 Mask             */

#define ADC_ADC1DAT5_ADC1DAT5_Pos        (0)                                               /*!< ADC_T::ADC1DAT5: ADC1DAT5 Position         */
#define ADC_ADC1DAT5_ADC1DAT5_Msk        (0xffful << ADC_ADC1DAT5_ADC1DAT5_Pos)            /*!< ADC_T::ADC1DAT5: ADC1DAT5 Mask             */

#define ADC_ADC1DAT6_ADC1DAT6_Pos        (0)                                               /*!< ADC_T::ADC1DAT6: ADC1DAT6 Position         */
#define ADC_ADC1DAT6_ADC1DAT6_Msk        (0xffful << ADC_ADC1DAT6_ADC1DAT6_Pos)            /*!< ADC_T::ADC1DAT6: ADC1DAT6 Mask             */

#define ADC_ADC1DAT7_ADC1DAT7_Pos        (0)                                               /*!< ADC_T::ADC1DAT7: ADC1DAT7 Position         */
#define ADC_ADC1DAT7_ADC1DAT7_Msk        (0xffful << ADC_ADC1DAT7_ADC1DAT7_Pos)            /*!< ADC_T::ADC1DAT7: ADC1DAT7 Mask             */

#define ADC_ADC1DAT8_ADC1DAT8_Pos        (0)                                               /*!< ADC_T::ADC1DAT8: ADC1DAT8 Position         */
#define ADC_ADC1DAT8_ADC1DAT8_Msk        (0xffful << ADC_ADC1DAT8_ADC1DAT8_Pos)            /*!< ADC_T::ADC1DAT8: ADC1DAT8 Mask             */

#define ADC_ADC1DAT9_ADC1DAT9_Pos        (0)                                               /*!< ADC_T::ADC1DAT9: ADC1DAT9 Position         */
#define ADC_ADC1DAT9_ADC1DAT9_Msk        (0xffful << ADC_ADC1DAT9_ADC1DAT9_Pos)            /*!< ADC_T::ADC1DAT9: ADC1DAT9 Mask             */

#define ADC_ADC1DAT10_ADC1DAT10_Pos      (0)                                               /*!< ADC_T::ADC1DAT10: ADC1DAT10 Position         */
#define ADC_ADC1DAT10_ADC1DAT10_Msk      (0xffful << ADC_ADC1DAT10_ADC1DAT10_Pos)          /*!< ADC_T::ADC1DAT10: ADC1DAT10 Mask             */

#define ADC_ADC1DAT11_ADC1DAT11_Pos      (0)                                               /*!< ADC_T::ADC1DAT11: ADC1DAT11 Position         */
#define ADC_ADC1DAT11_ADC1DAT11_Msk      (0xffful << ADC_ADC1DAT11_ADC1DAT11_Pos)          /*!< ADC_T::ADC1DAT11: ADC1DAT11 Mask             */

#define ADC_ADC1DAT12_ADC1DAT12_Pos      (0)                                               /*!< ADC_T::ADC1DAT12: ADC1DAT12 Position         */
#define ADC_ADC1DAT12_ADC1DAT12_Msk      (0xffful << ADC_ADC1DAT12_ADC1DAT12_Pos)          /*!< ADC_T::ADC1DAT12: ADC1DAT12 Mask             */

#define ADC_ADC1DAT13_ADC1DAT13_Pos      (0)                                               /*!< ADC_T::ADC1DAT13: ADC1DAT13 Position         */
#define ADC_ADC1DAT13_ADC1DAT13_Msk      (0xffful << ADC_ADC1DAT13_ADC1DAT13_Pos)          /*!< ADC_T::ADC1DAT13: ADC1DAT13 Mask             */

#define ADC_ADC1DAT14_ADC1DAT14_Pos      (0)                                               /*!< ADC_T::ADC1DAT14: ADC1DAT14 Position         */
#define ADC_ADC1DAT14_ADC1DAT14_Msk      (0xffful << ADC_ADC1DAT14_ADC1DAT14_Pos)          /*!< ADC_T::ADC1DAT14: ADC1DAT14 Mask             */

#define ADC_ADC1DAT15_ADC1DAT15_Pos      (0)                                               /*!< ADC_T::ADC1DAT15: ADC1DAT15 Position         */
#define ADC_ADC1DAT15_ADC1DAT15_Msk      (0xffful << ADC_ADC1DAT15_ADC1DAT15_Pos)          /*!< ADC_T::ADC1DAT15: ADC1DAT15 Mask             */
...
/*---------------------- Output Amplifier -------------------------*/
/**
    @addtogroup Output Amplifier(OP)
    Memory Mapped Structure for OP Controller
@{ */
...
/**
* @var OP_T::CTL
* Offset: 0x04  Output Amplifier Control Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[1]     |OP1EN     |Output Amplifier1 Enable Control
* |        |          |0 = Amplifier Disabled.
* |        |          |1 = Amplifier Enabled.
*/ 
    __I  uint32_t RESERVE0[1];
    __IO uint32_t CTL;                   /*!< [0x0004] Output Amplifier Control Register                                */
    
} OP_T;

/**
    @addtogroup OP_CONST OP Bit Field Definition
    Constant Definitions for OP Controller
@{ */

#define OP_CTL_OP1EN_Pos                 (1)                                               /*!< OP_T::CTL: OP1EN Position              */
#define OP_CTL_OP1EN_Msk                 (0x1ul << OP_CTL_OP1EN_Pos)                       /*!< OP_T::CTL: OP1EN Mask                  */

/**@}*/ /* OP_CONST */
/**@}*/ /* end of OP register group */


/**@}*/ /* end of REGISTER group */


/*---------------------- Gereral Direct Memory Access -------------------------*/
/**
    @addtogroup Gereral Direct Memory Access(GDMA)
...
/**
* @var GDMA_T::CTL
* Offset: 0x00  GDMA Control Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[0]     |GDMAEN    |GDMAEN (GDMA Enable).
...
* |[1]     |GPD       |GDMA Power Down. 
* |        |          |When set to 1, channel 0/1 registers are not accessible (except for this bit) and the channel of GDMA module is not functional.
* |        |          |0 = Normal GDMA module operation (default).
* |        |          |1 = The registers are not accessible and the GDMA module is not functional.
* |[3:2]   |GDMAMS    |GDMA Mode Select
* |        |          |00 = Software mode (Memory  Memody; APB  Memody) (default).
* |        |          |01 = External nXDREQ0 mode. USCI  Memody.
* |        |          |10, 11 = Reserved
* |[4]     |DADIR     |Destination Address Direction.
...
* |[5]     |SADIR     |Source Address Direction.
* |        |          |0 = Source address incremented successively (default).
* |        |          |1 = Source address decremented successively.
* |        |          |Note: This bit must not be set to 1, if Burst Mode Enable (BME) bit is also set to 1.
* |[6]     |DAFIX     |Destination Address Fixed.
* |        |          |0 = Change the Destination address during the GDMA operation (default).
* |        |          |1 = Do not change the Destination address during the GDMA operation.
* |        |          |This feature can be used when data is transferred from a single address source to a memory area destination.
* |[7]     |SAFIX     |Source Address Fixed.
* |        |          |0 = Change the source address during the GDMA operation (default).
* |        |          |1 = Do not change the source address during the GDMA operation.
* |        |          |This feature can be used when data is transferred from a single address source to a memory area destination.
* |[8]     |GIEN      |GDMA Interrupt Enable.
...
* |[13:12] |TWS       |Transfer Width. 
* |        |          |The GDMA_SCRB and GDMA_DSTB must be set to be aligned with the
* |        |          |data width selected by this field.
...
* |        |          |11 = Reserved.
* |[14]    |GPS       |GPS (GDMA Power Save). When set to 1, channel 0/1registers are accessible but both channels of the GDMA module is not functional.
* |        |          |0 = Normal GDMA module operation (default).
* |        |          |1 = The GDMA module is not functional.
* |[16]    |SOFTTRG   |Software Triggered GDMA.
...
* |[18]    |TC        |TC (Terminal Count). TC is the GDMA interrupt flag. TC or GDMAERR generate an interrupt.
...
* |[24]    |ACK_ATV   |ACK_ATV
* |        |          |0: nXDACK active high (default)
* |[25]    |REQ_ATV   |REQ_ATV
* |        |          |0: nXDREQ active high (default)
* @var GDMA_T::SRCB
* Offset: 0x04  GDMA Source Base Address Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[31:0]  |SrcBaseAddr|32-bit Source Base Address. 
* |        |          |The GDMA channel starts reading its data from the source address as defined in this source base address register.
* |        |          |During a block transfer, the GDMA determines successive destination addresses by adding to or subtracting from the source base address.
* @var GDMA_T::DSTB
* Offset: 0x08  GDMA Destination Base Address Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[31:0]  |DstBaseAddr|32-bit Destination Base Address. 
* |        |          |The GDMA channel starts writing its data to the destination address, as defined in this register.
* |        |          |During a block transfer, the GDMA determines successive destination addresses by adding to or subtracting from the destination base address.
* @var GDMA_T::TCNT
* Offset: 0x0C  GDMA Transfer Count Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[12:0]  |TfrCnt    |13-bit Transfer Count.
* |        |          |Represents the required number of GDMA transfers. The maximum transfer
* |        |          |count is 8K - 1. 
* @var GDMA_T::CSRC
* Offset: 0x10  GDMA Current Source Address Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[31:0]  |CurrentSrc|32-bit Current Source Address. 
* |        |          |Indicates the source address where the GDMA transfer just occurred.
* |        |          |During a block transfer, the GDMA determines the successive source addresses by adding to or subtracting from the source base address.
* |        |          |Depending on the settings in the control register, the current source address remains the same, is incremented or is decremented.
* @var GDMA_T::CDST
* Offset: 0x14  GDMA Current Destination Address Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[31:0]  |Current_Dst|32-bit Current Destination Address. 
* |        |          |Indicates the destination address where the GDMA transfer just occurred.
* |        |          |During a block transfer, the GDMA determines the successive destination addresses by adding to or subtracting from the destination base address.
* |        |          |Depending on the settings in the control register, the current destination address remains the same, is incremented or is decremented.
* @var GDMA_T::CTCNT
* Offset: 0x18  GDMA Current Transfer Count Register
* ---------------------------------------------------------------------------------------------------
* |Bits    |Field     |Descriptions
* | :----: | :----:   | :---- |
* |[12:0]  |CurrentTfrCnt|Current Transfer Count.
*/ 
    __IO uint32_t CTL;                   /*!< [0x0000] GDMA Control Register                                            */
    __IO uint32_t SRCB;                  /*!< [0x0004] Source Base Address Register                                     */
    __IO uint32_t DSTB;                  /*!< [0x0008] Destination Base Address Register                                */
    __IO uint32_t TCNT;                  /*!< [0x000C] Transfer Count Register                                          */
    __I  uint32_t CSRC;                  /*!< [0x0010] Current Source Register                                          */
    __I  uint32_t CDST;                  /*!< [0x0014] Current Destination Register                                     */
    __I  uint32_t CTCNT;                 /*!< [0x0018] Current Transfer Count Register                                  */

} GDMA_T;

/**
    @addtogroup GDMA_CONST GDMA Bit Field Definition
    Constant Definitions for GDMA Controller
@{ */

#define GDMA_CTL_GDMAEN_Pos              (0)                                               /*!< GDMA::CTL: GDMAEN Position             */
#define GDMA_CTL_GDMAEN_Msk              (0x1ul << GDMA_CTL_GDMAEN_Pos)                    /*!< GDMA::CTL: GDMAEN Mask                 */

#define GDMA_CTL_GDMAMS_Pos              (2)                                               /*!< GDMA::CTL: GDMAMS Position             */
#define GDMA_CTL_GDMAMS_Msk              (0x3ul << GDMA_CTL_GDMAMS_Pos)                    /*!< GDMA::CTL: GDMAMS Mask                 */

#define GDMA_CTL_DADIR_Pos               (4)                                               /*!< GDMA::CTL: DADIR Position              */
#define GDMA_CTL_DADIR_Msk               (0x1ul << GDMA_CTL_DADIR_Pos)                     /*!< GDMA::CTL: DADIR Mask                  */

#define GDMA_CTL_SADIR_Pos               (5)                                               /*!< GDMA::CTL: SADIR Position              */
#define GDMA_CTL_SADIR_Msk               (0x1ul << GDMA_CTL_SADIR_Pos)                     /*!< GDMA::CTL: SADIR Mask                  */

#define GDMA_CTL_DAFIX_Pos               (6)                                               /*!< GDMA::CTL: DAFIX Position              */
#define GDMA_CTL_DAFIX_Msk               (0x1ul << GDMA_CTL_DAFIX_Pos)                     /*!< GDMA::CTL: DAFIX Mask                  */

#define GDMA_CTL_SAFIX_Pos               (7)                                               /*!< GDMA::CTL: SAFIX Position              */
#define GDMA_CTL_SAFIX_Msk               (0x1ul << GDMA_CTL_SAFIX_Pos)                     /*!< GDMA::CTL: SAFIX Mask                  */

#define GDMA_CTL_GIEN_Pos                (8)                                               /*!< GDMA::CTL: SIEN Position               */
#define GDMA_CTL_GIEN_Msk                (0x1ul << GDMA_CTL_GIEN_Pos)                      /*!< GDMA::CTL: SIEN Mask                   */

#define GDMA_CTL_BME_Pos                 (9)                                               /*!< GDMA::CTL: BME Position                */
#define GDMA_CTL_BME_Msk                 (0x1ul << GDMA_CTL_BME_Pos)                       /*!< GDMA::CTL: BME Mask                    */

#define GDMA_CTL_TWS_Pos                 (12)                                              /*!< GDMA::CTL: TWS Position                */
#define GDMA_CTL_TWS_Msk                 (0x3ul << GDMA_CTL_TWS_Pos)                       /*!< GDMA::CTL: TWS Mask                    */

#define GDMA_CTL_SOFTTRG_Pos             (16)                                              /*!< GDMA::CTL: SOFTTRG Position            */
#define GDMA_CTL_SOFTTRG_Msk             (0x1ul << GDMA_CTL_SOFTTRG_Pos)                   /*!< GDMA::CTL: SOFTTRG Mask                */

#define GDMA_CTL_TCIF_Pos                (18)                                              /*!< GDMA::CTL: TCIF Position               */
#define GDMA_CTL_TCIF_Msk                (0x1ul << GDMA_CTL_TCIF_Pos)                      /*!< GDMA::CTL: TCIF Mask                   */

#define GDMA_CTL_GDMAERR_Pos             (20)                                              /*!< GDMA::CTL: GDMAERR Position            */
#define GDMA_CTL_GDMAERR_Msk             (0x1ul << GDMA_CTL_GDMAERR_Pos)                   /*!< GDMA::CTL: GDMAERR Mask                */

#define GDMA_TCNT_TfrCnt_Pos             (0)                                               /*!< GDMA::TCNT: TfrCnt Position           */
#define GDMA_TCNT_TfrCnt_Msk             (0x1ffful << GDMA_TCNT_TfrCnt_Pos)                /*!< GDMA::TCNT: TfrCnt Mask               */

#define GDMA_CTCNT_CurrentTfrCnt_Pos     (0)                                               /*!< GDMA::CTCNT: CurrentTfrCnt Position   */
#define GDMA_CTCNT_CurrentTfrCnt_Msk     (0x1ffful << GDMA_CTCNT_CurrentTfrCnt_Pos)        /*!< GDMA::CTCNT: CurrentTfrCnt Mask       */
...
#define APB3_BASE           ((     uint32_t)0x40200000)
...
#define PA_BASE              (GPIO_BASE      + 0x00000)                 /*!< GPIO PORTA Base Address                           */
#define PB_BASE              (GPIO_BASE      + 0x00040)                 /*!< GPIO PORTB Base Address                           */
#define PC_BASE              (GPIO_BASE      + 0x00080)                 /*!< GPIO PORTC Base Address                           */
#define PD_BASE              (GPIO_BASE      + 0x000C0)                 /*!< GPIO PORTD Base Address                           */
#define PE_BASE              (GPIO_BASE      + 0x00100)                 /*!< GPIO PORTE Base Address                           */
#define PF_BASE              (GPIO_BASE      + 0x00140)                 /*!< GPIO PORTF Base Address                           */
#define GPIO_DBNCECON_BASE   (GPIO_BASE      + 0x00440)                 /*!< GPIO De-bounce Cycle Control Base Address         */
#define GPIO_PIN_DATA_BASE   (GPIO_BASE      + 0x00800)                 /*!< GPIO Pin Data Input/Output Control Base Address   */
#define GDMA0_BASE           (AHB_BASE       + 0x08000)                 /*!< GDMA0 Base Address   			             	   */
#define GDMA1_BASE           (AHB_BASE       + 0x08020)                 /*!< GDMA1 Base Address   			             	   */
#define FMC_BASE             (AHB_BASE       + 0x0C000)                 /*!< Flash Memory Base Address                         */
#define HDIV0_BASE           (AHB_BASE       + 0x14000)                 /*!< Hardware Divider 0 Base Address                   */
#define HDIV1_BASE           (AHB_BASE       + 0x14020)                 /*!< Hardware Divider 1 Base Address                   */
#define HDIV2_BASE           (AHB_BASE       + 0x14040)                 /*!< Hardware Divider 2 Base Address                   */
#define HDIV_STS_BASE        (AHB_BASE       + 0x14010)                 /*!< Hardware Divider 2 Base Address                   */
#define WDT_BASE             (APB1_BASE      + 0x04000)                 /*!< Watchdog Timer Base Address                       */
#define TIMER0_BASE          (APB1_BASE      + 0x10000)                 /*!< Timer0 Base Address                               */
#define TIMER1_BASE          (APB1_BASE      + 0x10020)                 /*!< Timer1 Base Address                               */
#define TIMER2_BASE          (APB1_BASE      + 0x10080)                 /*!< Timer2 Base Address                               */
...
#define OP_BASE              (APB1_BASE      + 0xF0000)                 /*!< OP Base Address                                  */
...
#define USCI2_BASE           (APB3_BASE      + 0x70000)                 /*!< USCI2 Base Address                                */
...
#define GDMA0               ((GDMA_T *) GDMA0_BASE)                     /*!< GDMA0 Configuration Struct                       */
#define GDMA1               ((GDMA_T *) GDMA1_BASE)                     /*!< GDMA1 Configuration Struct                       */
#define FMC                 ((FMC_T *) FMC_BASE)                        /*!< FMC Configuration Struct                         */
#define HDIV0               ((HDIV_T *) HDIV0_BASE)                     /*!< HDIV0 Configuration Struct                       */
#define HDIV1               ((HDIV_T *) HDIV1_BASE)                     /*!< HDIV1 Configuration Struct                       */
#define HDIV2               ((HDIV_T *) HDIV2_BASE)                     /*!< HDIV2 Configuration Struct                       */
#define HDIV_STS            ((HDIV_STS_T *) HDIV_STS_BASE)              /*!< HDIV_STS Configuration Struct                    */
...
#define TIMER2              ((TIMER_T *) TIMER2_BASE)                   /*!< Timer0 Configuration Struct                      */
...
#define OP                  ((OP_T *) OP_BASE)                          /*!< OP Configuration Struct                          */
#define BPWM                ((BPWM_T *) BPWM_BASE)                      /*!< BPWM Configuration Struct                        */
#define ECAP                ((ECAP_T *) ECAP_BASE)                      /*!< ECAP Configuration Struct                        */
#define UI2C1               ((UI2C_T *) USCI1_BASE)                     /*!< UI2C1 Configuration Struct                       */
#define UI2C2               ((UI2C_T *) USCI2_BASE)                     /*!< UI2C1 Configuration Struct                       */
...
/* Creates a u32 value by concatenating the specified values. */
#if !defined(MAKELONG)
    #define MAKELONG(u16LowWord, u16HighWord)      ((unsigned long)(((unsigned short)(u16LowWord)) | ((unsigned long)((unsigned short)(u16HighWord))) << 16))
#endif

/* Creates a u16 value by concatenating the specified values. */
#if !defined(MAKEWORD)
    #define MAKEWORD(u8LowByte, u8HighByte)        ((unsigned short)(((unsigned char)(u8LowByte)) | ((unsigned short)((unsigned char)(u8HighByte))) << 8))
#endif
